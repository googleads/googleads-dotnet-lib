...
namespace com.google.api.adwords.examples
{
	...
	class CheckKeywordTrafficDemo
	{
		public static void run()
		{
			...
			KeywordTraffic[] estimates = 
				service.checkKeywordTraffic(trafficRequests);
			...
			{
				Console.WriteLine(
					"Given keyword(s) not expected to get any traffic.");
			}
