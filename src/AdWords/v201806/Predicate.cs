...
namespace Google.Api.Ads.AdWords.v201806
{
    ...
    public partial class Predicate
    {
        ...
        {
            return WithCondition(field, PredicateOperator.EQUALS, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.NOT_EQUALS, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.GREATER_THAN, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.GREATER_THAN_EQUALS, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.LESS_THAN, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.LESS_THAN_EQUALS, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.STARTS_WITH, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.STARTS_WITH_IGNORE_CASE, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.CONTAINS, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.CONTAINS_IGNORE_CASE, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.DOES_NOT_CONTAIN, new string[]
            {
                value
            });
        }
        ...
        {
            return WithCondition(field, PredicateOperator.DOES_NOT_CONTAIN_IGNORE_CASE, new string[]
            {
                value
            });
        }
