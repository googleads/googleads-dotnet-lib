    ...
    public partial class AdWordsService : AdsService
    {
        ...
        public class v201802
        {
            ...
            static v201802()
            {
                ...
                DataService = AdWordsService.MakeServiceSignature("v201802", "cm", "DataService");
                FeedItemService =
                ...
                FeedService = AdWordsService.MakeServiceSignature("v201802", "cm", "FeedService");
                FeedItemTargetService =
                    AdWordsService.MakeServiceSignature("v201802", "cm", "FeedItemTargetService");
                LabelService = AdWordsService.MakeServiceSignature("v201802", "cm", "LabelService");
                LocationCriterionService =
                    AdWordsService.MakeServiceSignature("v201802", "cm",
                        "LocationCriterionService");
                MediaService = AdWordsService.MakeServiceSignature("v201802", "cm", "MediaService");
                ...
                DraftService = AdWordsService.MakeServiceSignature("v201802", "cm", "DraftService");
                DraftAsyncErrorService =
                    AdWordsService.MakeServiceSignature("v201802", "cm", "DraftAsyncErrorService");
                TrialService = AdWordsService.MakeServiceSignature("v201802", "cm", "TrialService");
                ...
                OfflineDataUploadService =
                    AdWordsService.MakeServiceSignature("v201802", "rm",
                        "OfflineDataUploadService");
