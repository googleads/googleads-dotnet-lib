...
namespace Google.Api.Ads.AdWords.v201809
{
    ...
    /// </summary>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "https://adwords.google.com/api/adwords/cm/v201809", TypeName = "mutate")]
    ...
    {
        private BatchJobMutateResponse mutateResponseField;

        /// <summary>
        /// Gets or sets the mutate response.
        /// </summary>
        [System.Xml.Serialization.XmlElementAttribute(Namespace = "https://adwords.google.com/api/adwords/cm/v201809")]
        public BatchJobMutateResponse mutateResponse
        {
            get
            {
                return mutateResponseField;
            }
            set
            {
                mutateResponseField = value;
            }
        }
    }
