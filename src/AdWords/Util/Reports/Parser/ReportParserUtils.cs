  ...
  public static class ReportParserUtils {
    ...
    public static string GetPropNameFromColName<A>(string colName) {
      ...
      if (colNamePropNamePair == null) {
        throw new ArgumentException("There are no properties annotated with the given column name");
      }
    ...
    /// of each pair is the column name (if present), and the second element is the property name.
    /// </summary>
    /// <typeparam name="A">The POCO type</typeparam>
