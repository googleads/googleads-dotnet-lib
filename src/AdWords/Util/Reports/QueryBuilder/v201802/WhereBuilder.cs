...
namespace Google.Api.Ads.AdWords.Util.Reports.v201802 {
  ...
  public class WhereBuilder<TParent> : IWhereBuilder<TParent> {
    ...
    public TParent Equals(string propertyValue) {
      return SetCondition(PredicateOperator.EQUALS, new string[] { propertyValue });
    }
    ...
    public TParent Equals(int propertyValue) {
      return SetCondition(PredicateOperator.EQUALS, new int[] { propertyValue });
    }
    ...
    public TParent Equals(long propertyValue) {
      return SetCondition(PredicateOperator.EQUALS, new long[] { propertyValue });
    }
    ...
    public TParent Equals(bool propertyValue) {
      return SetCondition(PredicateOperator.EQUALS, new bool[] { propertyValue });
    }
    ...
    public TParent NotEquals(string propertyValue) {
      return SetCondition(PredicateOperator.NOT_EQUALS, new string[] { propertyValue });
    }
    ...
    public TParent NotEquals(int propertyValue) {
      return SetCondition(PredicateOperator.NOT_EQUALS, new int[] { propertyValue });
    }
    ...
    public TParent NotEquals(long propertyValue) {
      return SetCondition(PredicateOperator.NOT_EQUALS, new long[] { propertyValue });
    }
    ...
    public TParent NotEquals(bool propertyValue) {
      return SetCondition(PredicateOperator.NOT_EQUALS, new bool[] { propertyValue });
    }
    ...
    public TParent Contains(string propertyValue) {
      return SetCondition(PredicateOperator.CONTAINS, new string[] { propertyValue });
    }
    ...
    public TParent ContainsIgnoreCase(string propertyValue) {
      return SetCondition(PredicateOperator.CONTAINS_IGNORE_CASE, new string[] { propertyValue });
    }
    ...
    public TParent DoesNotContain(string propertyValue) {
      return SetCondition(PredicateOperator.DOES_NOT_CONTAIN, new string[] { propertyValue });
    }
    ...
    public TParent DoesNotContainIgnoreCase(string propertyValue) {
      return SetCondition(PredicateOperator.DOES_NOT_CONTAIN_IGNORE_CASE,
    ...
    public TParent GreaterThan(long propertyValue) {
      return SetCondition(PredicateOperator.GREATER_THAN, new long[] { propertyValue });
    }
    ...
    public TParent GreaterThan(int propertyValue) {
      return SetCondition(PredicateOperator.GREATER_THAN, new int[] { propertyValue });
    }
    ...
    public TParent GreaterThan(double propertyValue) {
      return SetCondition(PredicateOperator.GREATER_THAN, new double[] { propertyValue });
    }
    ...
    public TParent GreaterThanOrEqualTo(long propertyValue) {
      return SetCondition(PredicateOperator.GREATER_THAN_EQUALS, new long[] { propertyValue });
    }
    ...
    public TParent GreaterThanOrEqualTo(int propertyValue) {
      return SetCondition(PredicateOperator.GREATER_THAN_EQUALS, new int[] { propertyValue });
    }
    ...
    public TParent LessThan(long propertyValue) {
      return SetCondition(PredicateOperator.LESS_THAN, new long[] { propertyValue });
    }
    ...
    public TParent LessThan(int propertyValue) {
      return SetCondition(PredicateOperator.LESS_THAN, new int[] { propertyValue });
    }
    ...
    public TParent LessThan(double propertyValue) {
      return SetCondition(PredicateOperator.LESS_THAN, new double[] { propertyValue });
    }
    ...
    public TParent LessThanOrEqualTo(long propertyValue) {
      return SetCondition(PredicateOperator.LESS_THAN_EQUALS, new long[] { propertyValue });
    }
    ...
    public TParent StartsWith(string propertyValue) {
      return SetCondition(PredicateOperator.STARTS_WITH, new string[] { propertyValue });
    }
    ...
    public TParent StartsWithIgnoreCase(string propertyValue) {
      return SetCondition(PredicateOperator.STARTS_WITH_IGNORE_CASE,
          new string[] { propertyValue });
    }
  }
}