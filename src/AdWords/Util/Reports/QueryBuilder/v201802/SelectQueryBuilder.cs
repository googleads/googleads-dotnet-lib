...
namespace Google.Api.Ads.AdWords.Util.Reports.v201802
{
    ...
    public class SelectQueryBuilder : ISelectQueryBuilder<SelectQueryBuilder, SelectQuery>
    {
        ...
        /// <summary>
        /// Gets the total landscape points in the ad group bid landscape page.
        /// If the page has a null <code>entries</code> array, returns <code>0</code>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the total landscape points in the criterion bid landscape page.
        /// If the page has a null <code>entries</code> array, returns <code>0</code>.
        /// </summary>
