...
using ApiBatchJob = Google.Api.Ads.AdWords.v201802.BatchJob;

namespace Google.Api.Ads.AdWords.Util.BatchJob.v201802
{
    /// <summary>
    ...
    public class BatchJobUtilities : BatchJobUtilitiesBase
    {
        ...
        /// <returns>true, if the <see cref="WaitForPendingJob(long,int,WaitCallback)"/> method
        /// should be cancelled, false otherwise.</returns>
        ...
        /// <remarks>Use this method as a workaround for
        /// https://bugzilla.xamarin.com/show_bug.cgi?id=40793 if you are using VB.NET on Mono.
        /// Otherwise use <see cref="Upload(string, IEnumerable{Operation}, bool)"/> method.
        /// </remarks>
