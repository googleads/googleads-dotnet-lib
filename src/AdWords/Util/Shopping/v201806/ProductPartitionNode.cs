...
namespace Google.Api.Ads.AdWords.Util.Shopping.v201806
{
    /// <summary>
    ...
    public class ProductPartitionNode
    {
        ...
        {
            get { return productPartitionId; }
            set { productPartitionId = value; }
        }
        ...
        {
            get { return nodeState.NodeType == NodeType.SUBDIVISION; }
        }
        ...
        {
            get { return nodeState.NodeType == NodeType.BIDDABLE_UNIT; }
        }
        ...
        {
            get { return nodeState.NodeType == NodeType.EXCLUDED_UNIT; }
        }
        ...
        public long CpcBid
        {
            get { return nodeState.BidInMicros; }
            set { nodeState.BidInMicros = value; }
        }
        ...
        {
            get { return nodeState.BidInMicrosSpecified; }
            set { nodeState.BidInMicrosSpecified = value; }
        }
        ...
        public ProductPartitionNode(ProductPartitionNode parentNode, ProductDimension dimension,
            long productPartitionId) : this(parentNode, dimension, productPartitionId,
        ...
        public ProductPartitionNode GetChild(ProductDimension dimension)
        {
            if (!HasChild(dimension))
            {
                throw new ArgumentException(
                    string.Format(ShoppingMessages.NoChildNodeFoundForDimension, dimension));
            }
        ...
        public ProductPartitionNode AddChild(ProductDimension childDimension)
        {
            ...
            ProductPartitionNode newChild =
                new ProductPartitionNode(this, childDimension, 0, children.Comparer);
        ...
        public ProductPartitionNode AddChild(ProductPartitionNode childNode)
        {
            ...
            {
                throw new ArgumentException(
                    string.Format(ShoppingMessages.ParentNodeIsNotSubdivision, this.Dimension));
            }
        ...
        {
            PreconditionUtilities.CheckState(this.Parent != null,
                ShoppingMessages.RootCannotBeExcluded);
        ...
        internal ProductPartition GetCriterion()
        {
            ...
            partition.partitionType =
                this.IsUnit ? ProductPartitionType.UNIT : ProductPartitionType.SUBDIVISION;
            return partition;
        }
        ...
        internal ProductPartitionNode Clone()
        {
            ...
            {
                newDimension =
                    (ProductDimension) SerializationUtilities.CloneObject(this.Dimension);
            }
        ...
        private void CloneChildrenFrom(IEnumerable<ProductPartitionNode> children)
        {
            foreach (ProductPartitionNode childNode in children)
            {
                ...
                ProductDimension newDimension =
                    (ProductDimension) SerializationUtilities.CloneObject(childNode.Dimension);
            ...
            ProductPartitionNode toNode)
        {
            switch (fromNode.nodeState.NodeType)
            {
                ...
                default:
                    throw new InvalidOperationException("Unrecognized node state: " +
        ...
        private string DebugString(int level)
        {
            string dimensionType =
                (this.dimension != null) ? this.dimension.ProductDimensionType : "ROOT";
