...
namespace Google.Api.Ads.AdWords.Util.Shopping.v201806
{
    ...
    public class ProductDimensionEqualityComparer : IEqualityComparer<ProductDimension>
    {
        ...
        private int GetHashCodeInternal(ProductCustomAttribute obj)
        {
            if (obj.value == null)
            {
                return Tuple.Create<bool, ProductDimensionType>(obj.typeSpecified, obj.type)
                    .GetHashCode();
            }
            else
            {
                return Tuple
                    .Create<bool, ProductDimensionType, string>(obj.typeSpecified, obj.type,
                        obj.value.ToLower()).GetHashCode();
            }
        }
        ...
        {
            return Tuple.Create<bool, ShoppingProductChannel>(obj.channelSpecified, obj.channel)
                .GetHashCode();
        }
