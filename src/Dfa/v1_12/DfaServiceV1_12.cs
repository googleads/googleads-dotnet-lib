...
namespace Google.Api.Ads.Dfa.Lib {
  ...
  public partial class DfaService : AdsService {
    /// <summary>
    /// All the services available in v1.12.
    /// </summary>
    public class v1_12 {
      /// <summary>
      ...
      /// <summary>
      /// Factory type for v1.12 services.
      /// </summary>
      ...
      /// </summary>
      static v1_12() {
        AdRemoteService = DfaService.MakeServiceSignature("v1.12", "AdRemoteService");
        AdvertiserRemoteService = DfaService.MakeServiceSignature("v1.12",
            "AdvertiserRemoteService");
        AdvertiserGroupRemoteService = DfaService.MakeServiceSignature("v1.12",
            "AdvertiserGroupRemoteService");
        CampaignRemoteService = DfaService.MakeServiceSignature("v1.12", "CampaignRemoteService");
        ChangeLogRemoteService = DfaService.MakeServiceSignature("v1.12", "ChangeLogRemoteService");
        ContentCategoryRemoteService = DfaService.MakeServiceSignature("v1.12",
            "ContentCategoryRemoteService");
        CreativeRemoteService = DfaService.MakeServiceSignature("v1.12", "CreativeRemoteService");
        CreativeFieldRemoteService = DfaService.MakeServiceSignature("v1.12",
            "CreativeFieldRemoteService");
        CreativeGroupRemoteService = DfaService.MakeServiceSignature("v1.12",
            "CreativeGroupRemoteService");
        LoginRemoteService = DfaService.MakeServiceSignature("v1.12", "LoginRemoteService");
        NetworkRemoteService = DfaService.MakeServiceSignature("v1.12", "NetworkRemoteService");
        PlacementRemoteService = DfaService.MakeServiceSignature("v1.12", "PlacementRemoteService");
        SiteRemoteService = DfaService.MakeServiceSignature("v1.12", "SiteRemoteService");
        SizeRemoteService = DfaService.MakeServiceSignature("v1.12", "SizeRemoteService");
        SpotlightRemoteService = DfaService.MakeServiceSignature("v1.12", "SpotlightRemoteService");
        PlacementStrategyRemoteService = DfaService.MakeServiceSignature("v1.12",
            "PlacementStrategyRemoteService");
        SubnetworkRemoteService = DfaService.MakeServiceSignature("v1.12",
            "SubnetworkRemoteService");
        UserRemoteService = DfaService.MakeServiceSignature("v1.12", "UserRemoteService");
        UserRoleRemoteService = DfaService.MakeServiceSignature("v1.12", "UserRoleRemoteService");
      }
    }
  }
}
