...
namespace Google.Api.Ads.AdManager.Lib {
  ...
  public partial class AdManagerService : AdsService {
    ...
    public class v201805 {
      ...
      /// </summary>
      static v201805() {
        ActivityGroupService = AdManagerService.MakeServiceSignature("v201805",
            "ActivityGroupService");
        ActivityService = AdManagerService.MakeServiceSignature("v201805", "ActivityService");
        AdExclusionRuleService = AdManagerService.MakeServiceSignature("v201805",
            "AdExclusionRuleService");
        AdRuleService = AdManagerService.MakeServiceSignature("v201805", "AdRuleService");
        BaseRateService = AdManagerService.MakeServiceSignature("v201805", "BaseRateService");
        ContactService = AdManagerService.MakeServiceSignature("v201805", "ContactService");
        AudienceSegmentService = AdManagerService.MakeServiceSignature("v201805",
            "AudienceSegmentService");
        CdnConfigurationService = AdManagerService.MakeServiceSignature("v201805",
            "CdnConfigurationService");
        CompanyService = AdManagerService.MakeServiceSignature("v201805", "CompanyService");
        ContentBundleService = AdManagerService.MakeServiceSignature("v201805",
            "ContentBundleService");
        ContentService = AdManagerService.MakeServiceSignature("v201805", "ContentService");
        ContentMetadataKeyHierarchyService = AdManagerService.MakeServiceSignature("v201805",
            "ContentMetadataKeyHierarchyService");
        CreativeService = AdManagerService.MakeServiceSignature("v201805", "CreativeService");
        CreativeSetService = AdManagerService.MakeServiceSignature("v201805", "CreativeSetService");
        CreativeTemplateService = AdManagerService.MakeServiceSignature("v201805",
            "CreativeTemplateService");
        CreativeWrapperService = AdManagerService.MakeServiceSignature("v201805",
            "CreativeWrapperService");
        CustomTargetingService = AdManagerService.MakeServiceSignature("v201805",
            "CustomTargetingService");
        CustomFieldService = AdManagerService.MakeServiceSignature("v201805",
            "CustomFieldService");
        DaiAuthenticationKeyService = AdManagerService.MakeServiceSignature("v201805",
            "DaiAuthenticationKeyService");
        ExchangeRateService = AdManagerService.MakeServiceSignature("v201805",
            "ExchangeRateService");
        ForecastService = AdManagerService.MakeServiceSignature("v201805", "ForecastService");
        InventoryService = AdManagerService.MakeServiceSignature("v201805", "InventoryService");
        LabelService = AdManagerService.MakeServiceSignature("v201805", "LabelService");
        LineItemTemplateService = AdManagerService.MakeServiceSignature("v201805",
            "LineItemTemplateService");
        LineItemService = AdManagerService.MakeServiceSignature("v201805", "LineItemService");
        LineItemCreativeAssociationService =
            AdManagerService.MakeServiceSignature("v201805", "LineItemCreativeAssociationService");
        LiveStreamEventService = AdManagerService.MakeServiceSignature("v201805",
            "LiveStreamEventService");
        MobileApplicationService = AdManagerService.MakeServiceSignature("v201805",
            "MobileApplicationService");
        NativeStyleService = AdManagerService.MakeServiceSignature("v201805", "NativeStyleService");
        ...
        ProductPackageService = AdManagerService.MakeServiceSignature("v201805",
            "ProductPackageService");
        ProductPackageItemService = AdManagerService.MakeServiceSignature("v201805",
            "ProductPackageItemService");
        PlacementService = AdManagerService.MakeServiceSignature("v201805", "PlacementService");
        PremiumRateService = AdManagerService.MakeServiceSignature("v201805", "PremiumRateService");
        ProductService = AdManagerService.MakeServiceSignature("v201805", "ProductService");
        ProductTemplateService = AdManagerService.MakeServiceSignature("v201805",
            "ProductTemplateService");
        ProposalService = AdManagerService.MakeServiceSignature("v201805", "ProposalService");
        ProposalLineItemService = AdManagerService.MakeServiceSignature("v201805",
            "ProposalLineItemService");
        PublisherQueryLanguageService = AdManagerService.MakeServiceSignature("v201805",
            "PublisherQueryLanguageService");
        RateCardService = AdManagerService.MakeServiceSignature("v201805", "RateCardService");
        ReconciliationLineItemReportService = AdManagerService.MakeServiceSignature("v201805",
            "ReconciliationLineItemReportService");
        ReconciliationOrderReportService = AdManagerService.MakeServiceSignature("v201805",
            "ReconciliationOrderReportService");
        ReconciliationReportService = AdManagerService.MakeServiceSignature("v201805",
            "ReconciliationReportService");
        ReconciliationReportRowService = AdManagerService.MakeServiceSignature("v201805",
            "ReconciliationReportRowService");
        ReportService = AdManagerService.MakeServiceSignature("v201805", "ReportService");
        SuggestedAdUnitService = AdManagerService.MakeServiceSignature("v201805",
        ...
        UserTeamAssociationService = AdManagerService.MakeServiceSignature("v201805",
            "UserTeamAssociationService");
        WorkflowRequestService = AdManagerService.MakeServiceSignature("v201805",
