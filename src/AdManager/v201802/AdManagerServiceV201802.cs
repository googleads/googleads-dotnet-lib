...
namespace Google.Api.Ads.AdManager.Lib {
  ...
  public partial class AdManagerService : AdsService {
    ...
    public class v201802 {
      ...
      /// </summary>
      static v201802() {
        ActivityGroupService = AdManagerService.MakeServiceSignature("v201802",
            "ActivityGroupService");
        ActivityService = AdManagerService.MakeServiceSignature("v201802", "ActivityService");
        AdExclusionRuleService = AdManagerService.MakeServiceSignature("v201802",
            "AdExclusionRuleService");
        AdRuleService = AdManagerService.MakeServiceSignature("v201802", "AdRuleService");
        BaseRateService = AdManagerService.MakeServiceSignature("v201802", "BaseRateService");
        ContactService = AdManagerService.MakeServiceSignature("v201802", "ContactService");
        AudienceSegmentService = AdManagerService.MakeServiceSignature("v201802",
            "AudienceSegmentService");
        CdnConfigurationService = AdManagerService.MakeServiceSignature("v201802",
            "CdnConfigurationService");
        CompanyService = AdManagerService.MakeServiceSignature("v201802", "CompanyService");
        ContentBundleService = AdManagerService.MakeServiceSignature("v201802",
            "ContentBundleService");
        ContentService = AdManagerService.MakeServiceSignature("v201802", "ContentService");
        ContentMetadataKeyHierarchyService = AdManagerService.MakeServiceSignature("v201802",
            "ContentMetadataKeyHierarchyService");
        CreativeService = AdManagerService.MakeServiceSignature("v201802", "CreativeService");
        CreativeSetService = AdManagerService.MakeServiceSignature("v201802", "CreativeSetService");
        CreativeTemplateService = AdManagerService.MakeServiceSignature("v201802",
            "CreativeTemplateService");
        CreativeWrapperService = AdManagerService.MakeServiceSignature("v201802",
            "CreativeWrapperService");
        CustomTargetingService = AdManagerService.MakeServiceSignature("v201802",
            "CustomTargetingService");
        CustomFieldService = AdManagerService.MakeServiceSignature("v201802",
            "CustomFieldService");
        ExchangeRateService = AdManagerService.MakeServiceSignature("v201802",
            "ExchangeRateService");
        ForecastService = AdManagerService.MakeServiceSignature("v201802", "ForecastService");
        InventoryService = AdManagerService.MakeServiceSignature("v201802", "InventoryService");
        LabelService = AdManagerService.MakeServiceSignature("v201802", "LabelService");
        LineItemTemplateService = AdManagerService.MakeServiceSignature("v201802",
            "LineItemTemplateService");
        LineItemService = AdManagerService.MakeServiceSignature("v201802", "LineItemService");
        LineItemCreativeAssociationService =
            AdManagerService.MakeServiceSignature("v201802", "LineItemCreativeAssociationService");
        LiveStreamEventService = AdManagerService.MakeServiceSignature("v201802",
            "LiveStreamEventService");
        MobileApplicationService = AdManagerService.MakeServiceSignature("v201802",
            "MobileApplicationService");
        NativeStyleService = AdManagerService.MakeServiceSignature("v201802", "NativeStyleService");
        ...
        ProductPackageService = AdManagerService.MakeServiceSignature("v201802",
            "ProductPackageService");
        ProductPackageItemService = AdManagerService.MakeServiceSignature("v201802",
            "ProductPackageItemService");
        PlacementService = AdManagerService.MakeServiceSignature("v201802", "PlacementService");
        PremiumRateService = AdManagerService.MakeServiceSignature("v201802", "PremiumRateService");
        ProductService = AdManagerService.MakeServiceSignature("v201802", "ProductService");
        ProductTemplateService = AdManagerService.MakeServiceSignature("v201802",
            "ProductTemplateService");
        ProposalService = AdManagerService.MakeServiceSignature("v201802", "ProposalService");
        ProposalLineItemService = AdManagerService.MakeServiceSignature("v201802",
            "ProposalLineItemService");
        PublisherQueryLanguageService = AdManagerService.MakeServiceSignature("v201802",
            "PublisherQueryLanguageService");
        RateCardService = AdManagerService.MakeServiceSignature("v201802", "RateCardService");
        ReconciliationLineItemReportService = AdManagerService.MakeServiceSignature("v201802",
            "ReconciliationLineItemReportService");
        ReconciliationOrderReportService = AdManagerService.MakeServiceSignature("v201802",
            "ReconciliationOrderReportService");
        ReconciliationReportService = AdManagerService.MakeServiceSignature("v201802",
            "ReconciliationReportService");
        ReconciliationReportRowService = AdManagerService.MakeServiceSignature("v201802",
            "ReconciliationReportRowService");
        ReportService = AdManagerService.MakeServiceSignature("v201802", "ReportService");
        SuggestedAdUnitService = AdManagerService.MakeServiceSignature("v201802",
        ...
        UserTeamAssociationService = AdManagerService.MakeServiceSignature("v201802",
            "UserTeamAssociationService");
        WorkflowRequestService = AdManagerService.MakeServiceSignature("v201802",
