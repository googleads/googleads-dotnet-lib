...
namespace Google.Api.Ads.AdManager.Util.v202608
{
    /// <summary>
    ...
    public class PqlUtilities
    {
        ...
        private static string GetTextValue(Object value)
        {
            ...
            if (value is Google.Api.Ads.AdManager.v202608.Date)
            {
                Google.Api.Ads.AdManager.v202608.Date date =
                    (Google.Api.Ads.AdManager.v202608.Date) value;
                return string.Format("{0:0000}-{1:00}-{2:00}", date.year, date.month, date.day);
            }
            else if (value is Google.Api.Ads.AdManager.v202608.DateTime)
            {
                Google.Api.Ads.AdManager.v202608.DateTime dateTime =
                    (Google.Api.Ads.AdManager.v202608.DateTime) value;
