...
namespace Google.Api.Ads.AdManager.Util.v202102
{
    /// <summary>
    ...
    public class PqlUtilities
    {
        ...
        private static string GetTextValue(Object value)
        {
            ...
            if (value is Google.Api.Ads.AdManager.v202102.Date)
            {
                Google.Api.Ads.AdManager.v202102.Date date =
                    (Google.Api.Ads.AdManager.v202102.Date) value;
                return string.Format("{0:0000}-{1:00}-{2:00}", date.year, date.month, date.day);
            }
            else if (value is Google.Api.Ads.AdManager.v202102.DateTime)
            {
                Google.Api.Ads.AdManager.v202102.DateTime dateTime =
                    (Google.Api.Ads.AdManager.v202102.DateTime) value;
