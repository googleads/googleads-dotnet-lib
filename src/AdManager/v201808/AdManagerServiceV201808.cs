...
namespace Google.Api.Ads.AdManager.Lib {
  ...
  public partial class AdManagerService : AdsService {
    ...
    public class v201808 {
      ...
      /// </summary>
      static v201808() {
        ActivityGroupService = AdManagerService.MakeServiceSignature("v201808",
            "ActivityGroupService");
        ActivityService = AdManagerService.MakeServiceSignature("v201808", "ActivityService");
        AdExclusionRuleService = AdManagerService.MakeServiceSignature("v201808",
            "AdExclusionRuleService");
        AdRuleService = AdManagerService.MakeServiceSignature("v201808", "AdRuleService");
        BaseRateService = AdManagerService.MakeServiceSignature("v201808", "BaseRateService");
        ContactService = AdManagerService.MakeServiceSignature("v201808", "ContactService");
        AudienceSegmentService = AdManagerService.MakeServiceSignature("v201808",
            "AudienceSegmentService");
        CdnConfigurationService = AdManagerService.MakeServiceSignature("v201808",
            "CdnConfigurationService");
        CompanyService = AdManagerService.MakeServiceSignature("v201808", "CompanyService");
        ContentBundleService = AdManagerService.MakeServiceSignature("v201808",
            "ContentBundleService");
        ContentService = AdManagerService.MakeServiceSignature("v201808", "ContentService");
        ContentMetadataKeyHierarchyService = AdManagerService.MakeServiceSignature("v201808",
            "ContentMetadataKeyHierarchyService");
        CreativeService = AdManagerService.MakeServiceSignature("v201808", "CreativeService");
        CreativeSetService = AdManagerService.MakeServiceSignature("v201808", "CreativeSetService");
        CreativeTemplateService = AdManagerService.MakeServiceSignature("v201808",
            "CreativeTemplateService");
        CreativeWrapperService = AdManagerService.MakeServiceSignature("v201808",
            "CreativeWrapperService");
        CustomTargetingService = AdManagerService.MakeServiceSignature("v201808",
            "CustomTargetingService");
        CustomFieldService = AdManagerService.MakeServiceSignature("v201808",
            "CustomFieldService");
        DaiAuthenticationKeyService = AdManagerService.MakeServiceSignature("v201808",
            "DaiAuthenticationKeyService");
        ExchangeRateService = AdManagerService.MakeServiceSignature("v201808",
            "ExchangeRateService");
        ForecastService = AdManagerService.MakeServiceSignature("v201808", "ForecastService");
        InventoryService = AdManagerService.MakeServiceSignature("v201808", "InventoryService");
        LabelService = AdManagerService.MakeServiceSignature("v201808", "LabelService");
        LineItemTemplateService = AdManagerService.MakeServiceSignature("v201808",
            "LineItemTemplateService");
        LineItemService = AdManagerService.MakeServiceSignature("v201808", "LineItemService");
        LineItemCreativeAssociationService =
            AdManagerService.MakeServiceSignature("v201808", "LineItemCreativeAssociationService");
        LiveStreamEventService = AdManagerService.MakeServiceSignature("v201808",
            "LiveStreamEventService");
        MobileApplicationService = AdManagerService.MakeServiceSignature("v201808",
            "MobileApplicationService");
        NativeStyleService = AdManagerService.MakeServiceSignature("v201808", "NativeStyleService");
        ...
        ProductPackageService = AdManagerService.MakeServiceSignature("v201808",
            "ProductPackageService");
        ProductPackageItemService = AdManagerService.MakeServiceSignature("v201808",
            "ProductPackageItemService");
        PlacementService = AdManagerService.MakeServiceSignature("v201808", "PlacementService");
        PremiumRateService = AdManagerService.MakeServiceSignature("v201808", "PremiumRateService");
        ProductService = AdManagerService.MakeServiceSignature("v201808", "ProductService");
        ProductTemplateService = AdManagerService.MakeServiceSignature("v201808",
            "ProductTemplateService");
        ProposalService = AdManagerService.MakeServiceSignature("v201808", "ProposalService");
        ProposalLineItemService = AdManagerService.MakeServiceSignature("v201808",
            "ProposalLineItemService");
        PublisherQueryLanguageService = AdManagerService.MakeServiceSignature("v201808",
            "PublisherQueryLanguageService");
        RateCardService = AdManagerService.MakeServiceSignature("v201808", "RateCardService");
        ReconciliationLineItemReportService = AdManagerService.MakeServiceSignature("v201808",
            "ReconciliationLineItemReportService");
        ReconciliationOrderReportService = AdManagerService.MakeServiceSignature("v201808",
            "ReconciliationOrderReportService");
        ReconciliationReportService = AdManagerService.MakeServiceSignature("v201808",
            "ReconciliationReportService");
        ReconciliationReportRowService = AdManagerService.MakeServiceSignature("v201808",
            "ReconciliationReportRowService");
        ReportService = AdManagerService.MakeServiceSignature("v201808", "ReportService");
        SuggestedAdUnitService = AdManagerService.MakeServiceSignature("v201808",
        ...
        UserTeamAssociationService = AdManagerService.MakeServiceSignature("v201808",
            "UserTeamAssociationService");
        WorkflowRequestService = AdManagerService.MakeServiceSignature("v201808",
