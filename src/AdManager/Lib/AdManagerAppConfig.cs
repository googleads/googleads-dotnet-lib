...
namespace Google.Api.Ads.AdManager.Lib {
  ...
  public class AdManagerAppConfig : AppConfigBase {
    ...
    /// </summary>
    private ConfigSetting<string> adManagerApiServer = new ConfigSetting<string>(
        "AdManagerApi.Server", DEFAULT_ADMANAGER_API_SERVER);
    ...
    private ConfigSetting<AdManagerAuthorizationMethod> authorizationMethod =
        new ConfigSetting<AdManagerAuthorizationMethod>(
            "AuthorizationMethod", AdManagerAuthorizationMethod.OAuth2);
