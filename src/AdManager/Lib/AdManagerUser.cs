...
namespace Google.Api.Ads.AdManager.Lib {
  ...
  public partial class AdManagerUser : AdsUser {
    ...
    public AdManagerUser(Dictionary<string, string> headers)
      : base(new AdManagerAppConfig(), headers) {
    }
    ...
    /// </summary>
    public AdManagerUser(AdManagerAppConfig config)
        : base(config)
    {
    }
    ...
    public override SoapListener[] GetDefaultListeners() {
      return new SoapListener[] { AdManagerTraceListener.Instance };
    }
