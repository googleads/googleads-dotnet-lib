...
namespace Google.Api.Ads.Dfp.Lib {
  ...
  public partial class DfpService : AdsService {
    /// <summary>
    /// All the services available in v201010.
    /// </summary>
    public class v201010 {
      /// <summary>
      ...
      /// <summary>
      /// Factory type for v201010 services.
      /// </summary>
      ...
      /// </summary>
      static v201010() {
        CreativeService = DfpService.MakeServiceSignature("v201010", "CreativeService");
        PlacementService = DfpService.MakeServiceSignature("v201010", "PlacementService");
        LineItemService = DfpService.MakeServiceSignature("v201010", "LineItemService");
        UserService = DfpService.MakeServiceSignature("v201010", "UserService");
        OrderService = DfpService.MakeServiceSignature("v201010", "OrderService");
        LineItemCreativeAssociationService =
            DfpService.MakeServiceSignature("v201010", "LineItemCreativeAssociationService");
        InventoryService = DfpService.MakeServiceSignature("v201010", "InventoryService");
        CompanyService = DfpService.MakeServiceSignature("v201010", "CompanyService");
        ReportService = DfpService.MakeServiceSignature("v201010", "ReportService");
        ForecastService = DfpService.MakeServiceSignature("v201010", "ForecastService");
        NetworkService = DfpService.MakeServiceSignature("v201010", "NetworkService");
      }
    }
  }
}
