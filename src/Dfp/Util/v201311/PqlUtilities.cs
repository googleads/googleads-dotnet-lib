...
namespace Google.Api.Ads.Dfp.Util.v201311 {
  /// <summary>
  ...
  public class PqlUtilities {
    ...
    private static string getTextValue(Object value) {
      ...
      if (value is DateValue) {
        Google.Api.Ads.Dfp.v201311.DateValue dateValue =
            (Google.Api.Ads.Dfp.v201311.DateValue) value;
        return string.Format("{0:0000}-{1:00}-{2:00}", dateValue.value.year, dateValue.value.month,
            dateValue.value.day);
      } else if (value is DateTimeValue) {
        Google.Api.Ads.Dfp.v201311.DateTimeValue dateTimeValue =
            (Google.Api.Ads.Dfp.v201311.DateTimeValue) value;
