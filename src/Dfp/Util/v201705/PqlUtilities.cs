...
namespace Google.Api.Ads.Dfp.Util.v201705 {
  ...
  public class PqlUtilities {
    ...
    private static string GetTextValue(Object value) {
      ...
      if (value is Google.Api.Ads.Dfp.v201705.Date) {
        Google.Api.Ads.Dfp.v201705.Date date =
            (Google.Api.Ads.Dfp.v201705.Date) value;
        return string.Format("{0:0000}-{1:00}-{2:00}",
            date.year,
            date.month,
            date.day);
      } else if (value is Google.Api.Ads.Dfp.v201705.DateTime) {
        Google.Api.Ads.Dfp.v201705.DateTime dateTime =
            (Google.Api.Ads.Dfp.v201705.DateTime) value;
