...
namespace Google.Api.Ads.Dfp.Util.v201702 {
  /// <summary>
  ...
  public class PqlUtilities {
    ...
    private static string GetTextValue(Object value) {
      ...
      if (value is Google.Api.Ads.Dfp.v201702.Date) {
        Google.Api.Ads.Dfp.v201702.Date date =
            (Google.Api.Ads.Dfp.v201702.Date) value;
        return string.Format("{0:0000}-{1:00}-{2:00}",
            date.year,
            date.month,
            date.day);
      } else if (value is Google.Api.Ads.Dfp.v201702.DateTime) {
        Google.Api.Ads.Dfp.v201702.DateTime dateTime =
            (Google.Api.Ads.Dfp.v201702.DateTime) value;
