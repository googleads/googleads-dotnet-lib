...
namespace Google.Api.Ads.Dfp.Util.v201605 {
  /// <summary>
  ...
  public class PqlUtilities {
    ...
    private static string GetTextValue(Object value) {
      ...
      if (value is Google.Api.Ads.Dfp.v201605.Date) {
        Google.Api.Ads.Dfp.v201605.Date date =
            (Google.Api.Ads.Dfp.v201605.Date) value;
        return string.Format("{0:0000}-{1:00}-{2:00}",
            date.year,
            date.month,
            date.day);
      } else if (value is Google.Api.Ads.Dfp.v201605.DateTime) {
        Google.Api.Ads.Dfp.v201605.DateTime dateTime =
            (Google.Api.Ads.Dfp.v201605.DateTime) value;
