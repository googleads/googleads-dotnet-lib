...
namespace Google.Api.Ads.Dfp.Lib {
  ...
  /// </summary>
  [Serializable]
  public class DfpApiException : DfpException {
    /// <summary>
    ...
    /// server.</param>
    public DfpApiException(object apiException) : base() {
    ...
    public DfpApiException(object apiException, string message) : base(message) {
      this.apiException = apiException;
    }
    ...
    public DfpApiException(object apiException, string message, Exception innerException)
