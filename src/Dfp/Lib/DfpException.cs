...
namespace Google.Api.Ads.Dfp.Lib {
  ...
  /// </summary>
  [Serializable]
  public class DfpException : AdsException {
    /// <summary>
    /// Public constructor.
    /// </summary>
    public DfpException() : base() {
    }
    ...
    public DfpException(string message) : base(message) {
    }
    ...
    public DfpException(string message, Exception innerException)
    ...
    protected DfpException(SerializationInfo info, StreamingContext context)
        : base(info, context) {
    }
  }
}
