...
using Google.Api.Ads.AdWords.Util.v201402;
...
namespace Google.Api.Ads.AdWords.Tests.v201402 {
  /// <summary>
  /// A utility class to assist the testing of v201402 services.
  /// </summary>
  class TestUtils {
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201402.AdParamService);
    ...
    public long CreateLocationExtension(AdWordsUser user, long campaignId) {
      CampaignAdExtensionService campaignExtensionService =
          (CampaignAdExtensionService) user.GetService(AdWordsService.v201402.
    ...
    public GeoLocation GetLocationForAddress(AdWordsUser user, Address address) {
      GeoLocationService geoService =
          (GeoLocationService) user.GetService(AdWordsService.v201402.GeoLocationService);
