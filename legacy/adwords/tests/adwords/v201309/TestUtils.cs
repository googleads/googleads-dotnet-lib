...
using Google.Api.Ads.AdWords.Util.v201309;
...
namespace Google.Api.Ads.AdWords.Tests.v201309 {
  /// <summary>
  /// A utility class to assist the testing of v201309 services.
  /// </summary>
  class TestUtils {
    /// <summary>
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201309.AdParamService);
