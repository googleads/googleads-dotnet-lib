...
namespace Google.Api.Ads.AdWords.Examples.CSharp.v201406 {
  ...
  /// and attach it to an existing campaign. To get the list of campaigns,
  /// run GetCampaigns.cs.
  ///
  ...
  public class CreateAndAttachSharedKeywordSet : ExampleBase {
    ...
    public override string Description {
      get {
        return "This code example creates a shared keyword list, adds keywords to the list " +
            "and attach it to an existing campaign. To get the list of campaigns, run " +
            "GetCampaigns.cs.";
      }
    }
    ...
    /// <param name="campaignId">Id of the ad group to which ads are added.
    /// </param>
    ...
    public SharedSet CreateSharedKeywordSet(AdWordsUser user) {
      ...
      SharedSetService sharedSetService = (SharedSetService)
          user.GetService(AdWordsService.v201406.SharedSetService);
    ...
    public CampaignSharedSet AttachSharedSetToCampaign(AdWordsUser user, long campaignId,
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201406.CampaignSharedSetService);
