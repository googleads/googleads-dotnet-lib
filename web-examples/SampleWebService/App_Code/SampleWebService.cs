...
namespace com.google.api.adwords.websamples {
  /// <summary>
  /// Entry point for sample web service.
  /// </summary>
  ...
  public class SampleWebService : System.Web.Services.WebService {
    ...
    /// <summary>
    /// Creates an AdWords campaign remotely.
    /// </summary>
    /// <returns>The AdWords campaign id.</returns>
    [WebMethod]
    public long CreateCampaignRemotely() {
      return AddAdWordsCampaign();
    }
    ...
    public long AddAdWordsCampaign() {
      // Note: You could store the user in a session and re-use it,
      // or uncomment AuthToken key in Web.config and re-use the
      // login tokens.
