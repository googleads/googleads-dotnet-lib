...
namespace Google.Api.Ads.AdWords.Tests.v201605 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201605 services.
  /// </summary>
  internal class TestUtils {
    ...
    public void DeleteEnabledGmbFeeds(AdWordsUser user) {
      FeedService feedService =
          (FeedService) user.GetService(AdWordsService.v201605.FeedService);
    ...
    public void DeleteEnabledGmbCustomerFeeds(AdWordsUser user) {
      ...
      CustomerFeedReturnValue retval = customerFeedService.mutate(operations.ToArray());
    }
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201605.LabelService);
    ...
    public long CreateAdGroup(AdWordsUser user, long campaignId, bool isCpmBid) {
      AdGroupService adGroupService =
          (AdGroupService) user.GetService(AdWordsService.v201605.AdGroupService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201605.AdParamService);
    ...
    public long AddExperiment(AdWordsUser user, long campaignId, long adGroupId, long criterionId) {
      ...
      ExperimentService experimentService =
          (ExperimentService) user.GetService(AdWordsService.v201605.ExperimentService);
    ...
    public long CreateSharedKeywordSet(AdWordsUser user) {
      ...
      SharedSetService sharedSetService = (SharedSetService)
          user.GetService(AdWordsService.v201605.SharedSetService);
    ...
    public void AttachSharedSetToCampaign(AdWordsUser user, long campaignId, long sharedSetId) {
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201605.CampaignSharedSetService);
