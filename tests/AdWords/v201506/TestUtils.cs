...
using Google.Api.Ads.AdWords.Util.v201506;
...
namespace Google.Api.Ads.AdWords.Tests.v201506 {
  /// <summary>
  /// A utility class to assist the testing of v201506 services.
  /// </summary>
  class TestUtils {
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201506.AdParamService);
    ...
    public long AddExperiment(AdWordsUser user, long campaignId, long adGroupId, long criterionId) {
      ...
      ExperimentService experimentService =
          (ExperimentService) user.GetService(AdWordsService.v201506.ExperimentService);
