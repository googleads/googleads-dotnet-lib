...
namespace Google.Api.Ads.AdWords.Tests.v201708 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201708 services.
  /// </summary>
  internal class TestUtils {
    ...
    public void DeleteEnabledGmbFeeds(AdWordsUser user) {
      FeedService feedService =
          (FeedService) user.GetService(AdWordsService.v201708.FeedService);
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201708.LabelService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201708.AdParamService);
    ...
    public long CreateKeyword(AdWordsUser user, long adGroupId) {
      AdGroupCriterionService adGroupCriterionService =
         (AdGroupCriterionService) user.GetService(AdWordsService.v201708.AdGroupCriterionService);
    ...
    public long CreateSharedKeywordSet(AdWordsUser user) {
      ...
      SharedSetService sharedSetService = (SharedSetService)
          user.GetService(AdWordsService.v201708.SharedSetService);
