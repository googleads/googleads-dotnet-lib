...
using Google.Api.Ads.AdWords.Util.v201406;
...
namespace Google.Api.Ads.AdWords.Tests.v201406 {
  /// <summary>
  /// A utility class to assist the testing of v201406 services.
  /// </summary>
  class TestUtils {
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201406.AdParamService);
