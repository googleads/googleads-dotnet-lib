...
namespace Google.Api.Ads.AdWords.Tests.v201806 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201806 services.
  /// </summary>
  internal class TestUtils {
    ...
    public Draft AddDraft(AdWordsUser user, long baseCampaignId) {
      ...
      DraftService draftService = (DraftService) user.GetService(
        AdWordsService.v201806.DraftService);
    ...
    public long CreateKeyword(AdWordsUser user, long adGroupId) {
      AdGroupCriterionService adGroupCriterionService =
         (AdGroupCriterionService) user.GetService(AdWordsService.v201806.AdGroupCriterionService);
