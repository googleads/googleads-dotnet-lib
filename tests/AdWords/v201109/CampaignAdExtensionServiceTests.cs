...
namespace Google.Api.Ads.AdWords.Tests.v201109 {
  ...
  class CampaignAdExtensionServiceTests : BaseTests {
    ...
    /// <summary>
    /// Test whether we can get all active ad extensions in a campaign.
    /// </summary>
    [Test]
    public void TestGetAllActiveCampaignAdExtensions() {
      // Create a selector.
      Selector selector = new Selector();
      selector.fields = new string[] {"CampaignId", "AdExtensionId", "Status"};
