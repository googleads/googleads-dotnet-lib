...
namespace Google.Api.Ads.AdWords.Tests.v201109 {
  ...
  class TargetingIdeaServiceTests : BaseTests {
    ...
    public void TestGetCountryTargetSearchParameter() {
      ...
      LocationSearchParameter locationTargetSearchParam = new LocationSearchParameter();
      ...
      locationTargetSearchParam.locations = new Location[] {location1, location2};
      ...
      selector.searchParameters =
          new SearchParameter[] {locationTargetSearchParam, relatedToKeywordSearchParam};
      selector.ideaType = IdeaType.KEYWORD;
      selector.requestType = RequestType.IDEAS;
    ...
    public void TestGetLanguageTargetSearchParameter() {
      ...
      LanguageSearchParameter languageSearchParam = new LanguageSearchParameter();
      ...
      languageSearchParam.languages = new Language[] {language1, language2};
      ...
      selector.searchParameters =
          new SearchParameter[] {languageSearchParam, relatedToKeywordSearchParam};
      selector.ideaType = IdeaType.KEYWORD;
      selector.requestType = RequestType.IDEAS;
