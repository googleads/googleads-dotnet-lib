...
using VBExamples = Google.Api.Ads.AdWords.Examples.VB.v201509;

namespace Google.Api.Ads.AdWords.Tests.v201509 {

  /// <summary>
  /// Test cases for all the code examples under v201509\AdvancedOperations.
  /// </summary>
  internal class AdvancedOperationsTest : VersionedExampleTestsBase {
    ...
    /// <summary>
    /// Tests the AddTextAdWithUpgradedUrls C# code example.
    /// </summary>
    [Test]
    public void TestAddTextAdWithUpgradedUrlsCSharpExample() {
      AdWordsAppConfig config = (AdWordsAppConfig) user.Config;
      RunExample(delegate() {
        new CSharpExamples.AddTextAdWithUpgradedUrls().Run(user, adGroupId1);
      });
    }
