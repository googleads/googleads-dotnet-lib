...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201809
{
    ...
    public class ProductDimensionsTest
    {
        ...
        public void TestCreateBiddingCategory()
        {
            ...
            ProductBiddingCategory categoryB =
            ...
            ProductBiddingCategory categoryD =
                ProductDimensions.CreateBiddingCategory(ProductDimensionType.BIDDING_CATEGORY_L1);
        ...
        public void TestCreateCustomAttribute()
        {
            ...
            ProductCustomAttribute customAttributeB =
                ProductDimensions.CreateCustomAttribute(ProductDimensionType.BIDDING_CATEGORY_L1,
                    "google");
            ...
            ProductCustomAttribute customAttributeD =
                ProductDimensions.CreateCustomAttribute(ProductDimensionType.BIDDING_CATEGORY_L1);
        ...
        public void TestProductTypeEquals()
        {
            ...
            ProductType productTypeB =
                ProductDimensions.CreateType(ProductDimensionType.BRAND, "google");
