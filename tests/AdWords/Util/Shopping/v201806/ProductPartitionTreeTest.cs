    ...
    internal class ProductPartitionTreeTest : VersionedExampleTestsBase
    {
        ...
        public void TestDownloadAdGroupTree()
        {
            ProductPartitionTree partitionTree =
                shoppingTestUtils.CreateTestTreeForAddition(ADGROUP_ID);
            ...
            ProductPartitionTree newPartitionTree =
                ProductPartitionTree.DownloadAdGroupTree(user, ADGROUP_ID);
        ...
        {
            AdGroupCriterion rootCriterion =
                ShoppingTestUtils.CreateCriterionForProductPartition(1L, 0L, null, true, false);
            ...
            AdGroupCriterion removedCriterion =
                ShoppingTestUtils.CreateCriterionForProductPartition(2L, 1L, brandGoogle, true,
                    false);
            ((BiddableAdGroupCriterion) removedCriterion).userStatus = UserStatus.REMOVED;
            criteria.Add(removedCriterion);

            ProductPartitionTree tree = ProductPartitionTree.CreateAdGroupTree(criteria);
