...
using Google.Api.Ads.AdWords.Tests.v201710;
...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201710 {
    ...
    private void SetRootToEmpty() {
      ...
      if (root != null && root.ProductPartitionId >= 0L) {
        ...
        AdGroupCriterionService adGroupCriterionService = (AdGroupCriterionService)
            user.GetService(AdWordsService.v201710.AdGroupCriterionService);
