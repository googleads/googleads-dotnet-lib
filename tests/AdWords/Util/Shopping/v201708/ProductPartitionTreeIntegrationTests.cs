...
using Google.Api.Ads.AdWords.Tests.v201708;
using Google.Api.Ads.AdWords.Util.Shopping.v201708;
...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201708 {
    ...
    private void SetRootToEmpty() {
      ...
      if (root != null && root.ProductPartitionId >= 0L) {
        ...
        AdGroupCriterionService adGroupCriterionService = (AdGroupCriterionService)
            user.GetService(AdWordsService.v201708.AdGroupCriterionService);
