...
using Google.Api.Ads.AdWords.Tests.v201607;
using Google.Api.Ads.AdWords.Util.Shopping.v201607;
...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201607 {
    ...
    private void SetRootToEmpty() {
      ...
      if (root != null && root.ProductPartitionId >= 0L) {
        ...
        AdGroupCriterionService adGroupCriterionService = (AdGroupCriterionService)
            user.GetService(AdWordsService.v201607.AdGroupCriterionService);
