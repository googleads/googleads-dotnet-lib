...
using Google.Api.Ads.AdWords.Tests.v201702;
...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201702 {
    ...
    private void SetRootToEmpty() {
      ...
      if (root != null && root.ProductPartitionId >= 0L) {
        ...
        AdGroupCriterionService adGroupCriterionService = (AdGroupCriterionService)
            user.GetService(AdWordsService.v201702.AdGroupCriterionService);
