...
using Google.Api.Ads.AdWords.Tests.v201609;
using Google.Api.Ads.AdWords.Util.Shopping.v201609;
...
namespace Google.Api.Ads.AdWords.Tests.Util.Shopping.v201609 {
    ...
    private void SetRootToEmpty() {
      ...
      if (root != null && root.ProductPartitionId >= 0L) {
        ...
        AdGroupCriterionService adGroupCriterionService = (AdGroupCriterionService)
            user.GetService(AdWordsService.v201609.AdGroupCriterionService);
