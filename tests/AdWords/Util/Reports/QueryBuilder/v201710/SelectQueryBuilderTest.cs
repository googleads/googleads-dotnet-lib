...
using Google.Api.Ads.AdWords.Util.Reports.v201710;
using NUnit.Framework;
using System.Text.RegularExpressions;

namespace Google.Api.Ads.AdWords.Tests.Util.Reports.QueryBuilder.v201710 {
  ...
  internal class SelectQueryBuilderTest {
    ...
    public void TestStandardQueryConstruction() {
      ...
      Assert.AreEqual("SELECT CampaignId, Status, Clicks, Impressions WHERE Clicks = 20 " +
    ...
    public void TestMissingWhereClause() {
      ...
      Assert.AreEqual("SELECT CampaignId, Status, Clicks, Impressions ORDER BY " +
    ...
    public void TestStringParameters() {
      ...
      Assert.AreEqual("SELECT CampaignName, Status, Clicks, Impressions WHERE " +
    ...
    public void TestFieldsInSelectClause() {
      ...
      queryBuilder = new SelectQueryBuilder();
      query = queryBuilder
          .Select("CampaignId", "Status", "Clicks", "Status")
          .Build();
