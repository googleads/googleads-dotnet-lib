...
namespace Google.Api.Ads.AdWords.Tests.Util.Reports.QueryBuilder.v201710 {
  ...
  internal class ReportQueryBuilderTest {
    ...
    public void TestStandardQueryConstruction() {
      ...
      Assert.AreEqual("SELECT CampaignId, Status, Clicks, Impressions FROM " +
    ...
    public void TestFieldsInSelectClause() {
      ...
      Assert.AreEqual("SELECT CampaignId, Status, Clicks, Status FROM CAMPAIGN_PERFORMANCE_REPORT",
          query);
