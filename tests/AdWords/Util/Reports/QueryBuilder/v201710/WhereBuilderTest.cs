...
namespace Google.Api.Ads.AdWords.Tests.Util.Reports.QueryBuilder.v201710 {
  ...
  internal class WhereBuilderTest {
    ...
    public void TestContainsNone() {
      ...
      TestCondition(builder.ContainsNone(20.3, 30.4).ToString(), " CONTAINS_NONE [20.3, 30.4]");
    ...
    public void TestStartsWithIgnoreCase() {
      TestCondition(builder.StartsWithIgnoreCase("A").ToString(), " STARTS_WITH_IGNORE_CASE 'A'");
    }
  }
}
