...
namespace Google.Api.Ads.AdWords.Tests.v201710 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201710 services.
  /// </summary>
  internal class TestUtils {
    ...
    public void DeleteEnabledGmbFeeds(AdWordsUser user) {
      FeedService feedService =
          (FeedService) user.GetService(AdWordsService.v201710.FeedService);
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201710.LabelService);
    ...
    public long CreateDSACampaign(AdWordsUser user) {
      return CreateCampaign(user, AdvertisingChannelType.SEARCH, BiddingStrategyType.MANUAL_CPC,
          false, true);
    }
    ...
    public Draft AddDraft(AdWordsUser user, long baseCampaignId) {
      ...
      DraftService draftService = (DraftService) user.GetService(
        AdWordsService.v201710.DraftService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201710.AdParamService);
    ...
    public long CreateKeyword(AdWordsUser user, long adGroupId) {
      AdGroupCriterionService adGroupCriterionService =
         (AdGroupCriterionService) user.GetService(AdWordsService.v201710.AdGroupCriterionService);
    ...
    public long CreateSharedKeywordSet(AdWordsUser user) {
      ...
      SharedSetService sharedSetService = (SharedSetService)
          user.GetService(AdWordsService.v201710.SharedSetService);
    ...
    public void AttachSharedSetToCampaign(AdWordsUser user, long campaignId, long sharedSetId) {
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201710.CampaignSharedSetService);
