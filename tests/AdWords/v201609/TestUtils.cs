...
namespace Google.Api.Ads.AdWords.Tests.v201609 {

  /// <summary>
  /// A utility class to assist the testing of v201609 services.
  /// </summary>
  internal class TestUtils {
    ...
    public void DeleteEnabledGmbFeeds(AdWordsUser user) {
      FeedService feedService =
          (FeedService) user.GetService(AdWordsService.v201609.FeedService);
    ...
    public void DeleteEnabledGmbCustomerFeeds(AdWordsUser user) {
      CustomerFeedService customerFeedService = (CustomerFeedService) user.GetService(
          AdWordsService.v201609.CustomerFeedService);
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201609.LabelService);
    ...
    public Draft AddDraft(AdWordsUser user, long baseCampaignId) {
      ...
      DraftService draftService = (DraftService) user.GetService(
        AdWordsService.v201609.DraftService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201609.AdParamService);
    ...
    public long CreateSharedKeywordSet(AdWordsUser user) {
      ...
      SharedSetService sharedSetService = (SharedSetService)
          user.GetService(AdWordsService.v201609.SharedSetService);
    ...
    public void AttachSharedSetToCampaign(AdWordsUser user, long campaignId, long sharedSetId) {
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201609.CampaignSharedSetService);
