...
namespace Google.Api.Ads.AdWords.Tests.v201802 {
  ...
  /// <summary>
  /// Test cases for all the code examples under v201802\AdvancedOperations.
  /// </summary>
  internal class AdvancedOperationsTest : VersionedExampleTestsBase {
    ...
    public void Init() {
      ...
      gmailAdGroupId = utils.CreateAdGroup(user, gmailCampaignId, AdGroupType.DISPLAY_STANDARD,
          true);
    ...
    public void TestAddGmailAdCSharpExample() {
      RunExample(delegate () {
        new CSharpExamples.AddGmailAd().Run(user, gmailAdGroupId);
      });
    }
    ...
    public void TestAddGmailAdVBExample() {
      RunExample(delegate () {
        new VBExamples.AddGmailAd().Run(user, gmailAdGroupId);
      });
    }
    ...
    public void TestAddShoppingDynamicRemarketingCampaignCSharpExample() {
      ...
      RunExample(delegate () {
        new CSharpExamples.AddShoppingDynamicRemarketingCampaign().Run(
