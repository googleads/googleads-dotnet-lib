...
namespace Google.Api.Ads.AdWords.Tests.v201802 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201802 services.
  /// </summary>
  internal class TestUtils {
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201802.LabelService);
    ...
    public long CreateMobileSearchCampaign(AdWordsUser user, BiddingStrategyType strategyType) {
      return CreateCampaign(user, AdvertisingChannelType.SEARCH, strategyType, true, false, false);
    }
    ...
    public long CreateGmailCampaign(AdWordsUser user) {
      return CreateCampaign(user, AdvertisingChannelType.DISPLAY, BiddingStrategyType.MANUAL_CPC,
          false, false, true);
    }
    ...
    public long CreateTrial(AdWordsUser user, long draftId, long baseCampaignId) {
      ...
      TrialService trialService = (TrialService) user.GetService(
        AdWordsService.v201802.TrialService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201802.AdParamService);
    ...
    public long CreateKeyword(AdWordsUser user, long adGroupId) {
      AdGroupCriterionService adGroupCriterionService =
         (AdGroupCriterionService) user.GetService(AdWordsService.v201802.AdGroupCriterionService);
