...
namespace Google.Api.Ads.AdWords.Tests.v201802
{
    ...
    internal class ShoppingTestUtils
    {
        ...
        /// </summary>
        internal readonly ProductDimension BRAND_MOTOROLA =
            ProductDimensions.CreateBrand("motorola");
        ...
        private ProductPartitionTree CreateTestTree(long adGroupId, long rootId)
        {
            ...
            {
                CreateCriterionForProductPartition(rootId, ProductPartitionTree.ROOT_PARENT_ID,
                    null, false, false), // root
                CreateCriterionForProductPartition(counterStart - 1L, rootId, BRAND_GOOGLE, true,
                    false, 100000L), // google
                CreateCriterionForProductPartition(counterStart - 2L, rootId, BRAND_MOTOROLA, true,
                    false, 50000L), // Motorola
                CreateCriterionForProductPartition(counterStart - 3L, rootId, BRAND_OTHER, true,
                    true), // Other

                CreateCriterionForProductPartition(counterStart - 4L, counterStart - 1L, OFFER_A,
                    true, false, 30000L), // offerA
                CreateCriterionForProductPartition(counterStart - 5L, counterStart - 1L, OFFER_B,
                    true, true, 30000L), // offerB
                CreateCriterionForProductPartition(counterStart - 6L, counterStart - 1L,
                    OFFER_OTHER, true, false, 50000L), // Other
            };
            ...
            ProductPartitionNode partitionNode, AdGroupCriterionOperation[] mutateOperations)
        {
            ...
            foreach (AdGroupCriterionOperation operation in mutateOperations)
            {
                switch (operation.@operator)
                {
                    ...
                    case Operator.ADD:
                        if (comparer.Equals(
                            (operation.operand.criterion as ProductPartition).caseValue,
