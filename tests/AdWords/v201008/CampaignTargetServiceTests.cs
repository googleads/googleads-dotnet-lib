  ...
  class CampaignTargetServiceTests : BaseTests {
    ...
    public void Init() {
      ...
      campaignTargetService = (CampaignTargetService) user.GetService(
          AdWordsService.v201008.CampaignTargetService);
    ...
    public void TestAddAdScheduleTarget() {
      ...
      scheduleTarget.dayOfWeek = Google.Api.Ads.AdWords.v201008.DayOfWeek.MONDAY;
    ...
    /// <summary>
    /// Test whether we can add mobile targets to a campaign.
    /// </summary>
    [Test]
    public void TestAddMobileTarget() {
      ...
      mobilePlatformTarget1.platformName = "iPad";

      MobilePlatformTarget mobilePlatformTarget2 = new MobilePlatformTarget();
      mobilePlatformTarget2.platformName = "iPhone";

      // Target Carriers - T-Mobile US, Sprint US, AT&T US.
      ...
      MobileCarrierTarget mobileCarrierTarget2 = new MobileCarrierTarget();
      mobileCarrierTarget2.carrierName = "Sprint";
      mobileCarrierTarget2.countryCode = "US";

      MobileCarrierTarget mobileCarrierTarget3 = new MobileCarrierTarget();
    ...
    /// <summary>
    /// Test whether we can remove mobile targets.
    /// </summary>
    [Test]
