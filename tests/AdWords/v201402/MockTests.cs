...
namespace Google.Api.Ads.AdWords.Tests.v201402 {
  ...
  /// </summary>
  [TestFixture]
  class MockTests : ExampleTestsBase {
    /// <summary>
    ...
    public class MockCampaignServiceEx : CampaignService {
      ...
      [SoapDocumentMethodAttribute("",
          RequestNamespace = "https://adwords.google.com/api/adwords/cm/v201402",
          ResponseNamespace = "https://adwords.google.com/api/adwords/cm/v201402",
    ...
    public void TestGetAllCampaignsMockOnly() {
      MockUtilities.RegisterMockService(user, AdWordsService.v201402.CampaignService,
    ...
    public void TestUpdateCampaignsMockRequestAndResponse() {
      ExamplesMockData mockData = LoadMockData(SoapMessages_v201402.UpdateCampaign);
    ...
    private void VerifyUpdateCampaignRequest(Uri requestUri, WebHeaderCollection headers,
      ...
      CampaignOperation campaignOperation =
          (CampaignOperation) SerializationUtilities.DeserializeFromXmlTextCustomRootNs(
              ...
              "https://adwords.google.com/api/adwords/cm/v201402", "operations");
