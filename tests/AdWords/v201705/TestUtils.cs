...
namespace Google.Api.Ads.AdWords.Tests.v201705 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201705 services.
  /// </summary>
  internal class TestUtils {
    ...
    public long CreateBudget(AdWordsUser user) {
      BudgetService budgetService =
          (BudgetService) user.GetService(AdWordsService.v201705.BudgetService);
    ...
    public void DeleteEnabledGmbFeeds(AdWordsUser user) {
      FeedService feedService =
          (FeedService) user.GetService(AdWordsService.v201705.FeedService);
    ...
    public long CreateLabel(AdWordsUser user) {
      LabelService labelService =
          (LabelService) user.GetService(AdWordsService.v201705.LabelService);
    ...
    public Draft AddDraft(AdWordsUser user, long baseCampaignId) {
      ...
      DraftService draftService = (DraftService) user.GetService(
        AdWordsService.v201705.DraftService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201705.AdParamService);
    ...
    public void AttachSharedSetToCampaign(AdWordsUser user, long campaignId, long sharedSetId) {
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201705.CampaignSharedSetService);
