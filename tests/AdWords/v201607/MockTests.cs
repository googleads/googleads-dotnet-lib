...
using CSharpExamples = Google.Api.Ads.AdWords.Examples.CSharp.v201607;
  ...
  internal class MockTests : VersionedMockedExampleTestsBase {
    ...
    public class MockCampaignServiceEx : CampaignService {
      ...
      [SoapDocumentMethodAttribute("",
          RequestNamespace = "https://adwords.google.com/api/adwords/cm/v201607",
          ResponseNamespace = "https://adwords.google.com/api/adwords/cm/v201607",
    ...
    public void TestGetAllCampaignsMockOnly() {
      ServiceSignature mockSignature = MockUtilities.RegisterMockService(user,
          AdWordsService.v201607.CampaignService, typeof(MockCampaignService));
    ...
    public void TestGetAllCampaignsMockAndCallServer() {
      ServiceSignature mockSignature = MockUtilities.RegisterMockService(user,
          AdWordsService.v201607.CampaignService, typeof(MockCampaignServiceEx));
    ...
    public void TestUpdateCampaignsMockRequestAndResponse() {
      ...
      try {
        ...
        ExamplesMockData mockData = LoadMockData(SoapMessages_v201607.UpdateCampaign);
    ...
    private void VerifyUpdateCampaignRequest(Uri requestUri, WebHeaderCollection headers,
      ...
      CampaignOperation campaignOperation =
          (CampaignOperation) SerializationUtilities.DeserializeFromXmlTextCustomRootNs(
              ...
              "https://adwords.google.com/api/adwords/cm/v201607", "operations");
