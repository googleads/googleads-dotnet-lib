  ...
  internal class MockTests : VersionedExampleTestsBase {
    ...
    public class MockCampaignServiceEx : CampaignService {
      ...
      [SoapDocumentMethodAttribute("",
          RequestNamespace = "https://adwords.google.com/api/adwords/cm/v201601",
          ResponseNamespace = "https://adwords.google.com/api/adwords/cm/v201601",
    ...
    public void TestGetAllCampaignsMockOnly() {
      ServiceSignature mockSignature = MockUtilities.RegisterMockService(user,
          AdWordsService.v201601.CampaignService, typeof(MockCampaignService));
    ...
    public void TestUpdateCampaignsMockRequestAndResponse() {
      ExamplesMockData mockData = LoadMockData(SoapMessages_v201601.UpdateCampaign);
