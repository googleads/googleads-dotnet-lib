...
namespace Google.Api.Ads.AdWords.Tests.v201601 {
  ...
  /// <summary>
  /// A utility class to assist the testing of v201601 services.
  /// </summary>
  class TestUtils {
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201601.AdParamService);
    ...
    public void AttachSharedSetToCampaign(AdWordsUser user, long campaignId, long sharedSetId) {
      ...
      CampaignSharedSetService campaignSharedSetService = (CampaignSharedSetService)
          user.GetService(AdWordsService.v201601.CampaignSharedSetService);
