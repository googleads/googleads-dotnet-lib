...
namespace Google.Api.Ads.Dfp.Tests.v201004 {
  ...
  public class TestUtils {
    ...
    public User GetUserByEmail(DfpUser user, string email) {
      UserService userService = (UserService) user.GetService(DfpService.v201004.UserService);
    ...
    public Creative CreateCreative(DfpUser user, long advertiserId) {
      CreativeService creativeService = (CreativeService)user.GetService(
          DfpService.v201004.CreativeService);
    ...
    public AdUnit CreateAdUnit(DfpUser user) {
      InventoryService inventoryService =
          (InventoryService) user.GetService(DfpService.v201004.InventoryService);
    ...
    public Placement CreatePlacement(DfpUser user, string[] targetedAdUnitIds) {
      ...
      PlacementService placementService =
          (PlacementService) user.GetService(DfpService.v201004.PlacementService);
    ...
    public ReportJob CreateReport(DfpUser user) {
      ...
      ReportService reportService =
          (ReportService) user.GetService(DfpService.v201004.ReportService);
