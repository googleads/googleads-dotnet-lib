...
// Author: christopherseeley@gmail.com (Christopher Seeley)
...
using DateTime = Google.Api.Ads.Dfp.v201408.DateTime;
...
namespace Google.Api.Ads.Dfp.Tests.v201408 {
  ...
  public class StatementBuilderTests {
    ...
    public void TestStatementBuilderThrowsExceptionMixingStylesWhere() {
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesFrom() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .From("Geo_Table");
    }

    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesSelect() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .Select("Id, Type");
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesLimit() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .Limit(StatementBuilder.SUGGESTED_PAGE_LIMIT);
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesOffset() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .Offset(100);
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesIncreaseOffset() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .IncreaseOffsetBy(100);
    }

    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionMixingStylesRemoveLimitAndOffset() {
      StatementBuilder statementBuilder = new StatementBuilder(
          "SELECT Id, Type FROM Geo_Table WHERE Type = City")
          .RemoveLimitAndOffset();
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionSettingQueryWithSelect() {
      StatementBuilder statementBuilder = new StatementBuilder()
          .Select("Id, Type");
      statementBuilder.Query = "SELECT Id, Type FROM Geo_Table WHERE Type = City";
    }

    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionSettingQueryWithFrom() {
      StatementBuilder statementBuilder = new StatementBuilder()
        .From("Geo_Table");
      statementBuilder.Query = "SELECT Id, Type FOM Geo_Table WHERE Type = City";
    }

    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionSettingQueryWithWhere() {
      StatementBuilder statementBuilder = new StatementBuilder()
        .Where("Type = City");
      statementBuilder.Query = "SELECT Id, Type FOM Geo_Table WHERE Type = City";
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionSettingQueryWithLimit() {
      StatementBuilder statementBuilder = new StatementBuilder()
        .Limit(StatementBuilder.SUGGESTED_PAGE_LIMIT);
      statementBuilder.Query = "SELECT Id, Type FOM Geo_Table WHERE Type = City";
    }
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))]
    public void TestStatementBuilderThrowsExceptionSettingQueryWithOffset() {
      StatementBuilder statementBuilder = new StatementBuilder()
        .Offset(100);
      statementBuilder.Query = "SELECT Id, Type FOM Geo_Table WHERE Type = City";
    }
