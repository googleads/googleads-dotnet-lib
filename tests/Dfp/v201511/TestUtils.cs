...
namespace Google.Api.Ads.Dfp.Tests.v201511 {
  /// <summary>
  /// A utility class to assist the testing of v201511 services.
  /// </summary>
  public class TestUtils {
    ...
    public User GetUserByEmail(DfpUser user, string email) {
      UserService userService = (UserService) user.GetService(DfpService.v201511.UserService);
    ...
    public Company CreateCompany(DfpUser user, CompanyType companyType) {
      CompanyService companyService = (CompanyService) user.GetService(
          DfpService.v201511.CompanyService);
