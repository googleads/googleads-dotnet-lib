...
namespace Google.Api.Ads.Dfp.Tests
{
    ...
    public class DfpSoapHeaderInspectorTests
    {
        ...
        public void TestNullHeaderInvalid()
        {
            ...
            Assert.Throws(typeof(DfpApiException),
                delegate() { inspector.BeforeSendRequest(ref this.message, this.channel); },
        ...
        public void TestHeaderUpdatesApplied()
        {
            ...
            DfpSoapClient<IMockAdsService> service =
                new DfpSoapClient<IMockAdsService>(new BasicHttpBinding(),
