...
namespace Google.Api.Ads.Dfp.Tests.Lib
{
    /// <summary>
    /// Tests for DfpTraceListener class.
    /// </summary>
    [TestFixture]
    class DfpTraceListenerTests
    {
        /// <summary>
        ...
        public void Init()
        {
            listener = DfpTraceListener.Instance;

            // Set static values for testing
            DfpAppConfig config = (DfpAppConfig) listener.Config;
