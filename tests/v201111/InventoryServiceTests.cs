...
namespace Google.Api.Ads.Dfp.Tests.v201111 {
  ...
  public class InventoryServiceTests : BaseTests {
    ...
    public void Init() {
      ...
      inventoryService = (InventoryService) user.GetService(DfpService.v201111.InventoryService);
    ...
    /// <summary>
    /// Test whether we can fetch a list of ad unit sizes.
    /// </summary>
    [Test]
    public void TestGetAdUnitSizes() {
      AdUnitSize[] adUnitSizes = null;
