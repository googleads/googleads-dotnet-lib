...
namespace com.google.api.adwords.tests.v200909 {
  ...
  class TargetingIdeaServiceTests : BaseTests {
    ...
    /// </summary>
    [Test]
    public void TestGetNgramGroupsSearchParameter() {
      TargetingIdeaSelector selector = new TargetingIdeaSelector();

      NgramGroupsSearchParameter nGramGroupsSearchParameter = new NgramGroupsSearchParameter();
      nGramGroupsSearchParameter.ngramGroups = new string[] {"27"};
