...
namespace Google.Api.Ads.AdWords.Tests.v201306 {
  /// <summary>
  /// Test cases for all the code examples under v201306\CampaignManagement.
  /// </summary>
  class CampaignManagementTest : VersionedExampleTestsBase {
    ...
    /// <summary>
    /// Tests the AddLegacySiteLinks VB.NET code example.
    /// </summary>
    [Test]
    public void TestAddLegacySiteLinksVBExample() {
      RunExample(delegate() {
        new VBExamples.AddLegacySiteLinks().Run(user, campaignId);
      });
    }

    /// <summary>
    /// Tests the AddLegacySiteLinks C# code example.
    /// </summary>
    [Test]
    public void TestAddLegacySiteLinksCSharpExample() {
      RunExample(delegate() {
        new CSharpExamples.AddLegacySiteLinks().Run(user, campaignId);
      });
    }

    /// <summary>
    /// Tests the DeleteLegacySitelinks VB.NET code example.
    /// </summary>
    [Test]
    public void TestDeleteLegacySitelinksVBExample() {
      RunExample(delegate() {
        new VBExamples.DeleteLegacySitelinks().Run(user, campaignId);
      });
    }

    /// <summary>
    /// Tests the DeleteLegacySitelinks C# code example.
    /// </summary>
    [Test]
    public void TestDeleteLegacySitelinksCSharpExample() {
      RunExample(delegate() {
        new CSharpExamples.DeleteLegacySitelinks().Run(user, campaignId);
      });
    }
