...
using Google.Api.Ads.AdWords.Util.v201306;
...
namespace Google.Api.Ads.AdWords.Tests.v201306 {
  /// <summary>
  /// A utility class to assist the testing of v201306 services.
  /// </summary>
  class TestUtils {
    /// <summary>
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201306.AdParamService);
