...
namespace Google.Api.Ads.AdWords.Tests.v201209 {
  /// <summary>
  /// A utility class to assist the testing of v201209 services.
  /// </summary>
  class TestUtils {
    /// <summary>
    ...
    public long CreateAdGroup(AdWordsUser user, long campaignId, bool isCpmBid) {
      AdGroupService adGroupService =
          (AdGroupService) user.GetService(AdWordsService.v201209.AdGroupService);
    ...
    public void SetAdParam(AdWordsUser user, long adGroupId, long criterionId) {
      AdParamService adParamService =
          (AdParamService) user.GetService(AdWordsService.v201209.AdParamService);
    ...
    public long CreateKeyword(AdWordsUser user, long adGroupId) {
      AdGroupCriterionService adGroupCriterionService =
         (AdGroupCriterionService) user.GetService(AdWordsService.v201209.AdGroupCriterionService);
    ...
    public long AddExperiment(AdWordsUser user, long campaignId, long adGroupId, long criterionId) {
      ...
      ExperimentService experimentService =
          (ExperimentService) user.GetService(AdWordsService.v201209.ExperimentService);
    ...
    public GeoLocation GetLocationForAddress(AdWordsUser user, Address address) {
      GeoLocationService geoService =
          (GeoLocationService) user.GetService(AdWordsService.v201209.GeoLocationService);
