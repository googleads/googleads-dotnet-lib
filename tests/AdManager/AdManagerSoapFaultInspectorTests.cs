...
namespace Google.Api.Ads.AdManager.Tests
{
  ...
  <soap:Header>
    <ResponseHeader xmlns=""https://www.google.com/apis/ads/publisher/v202608"">
  ...
  <soap:Body>
    <soap:Fault>
      ...
      <detail>
        <ApiExceptionFault xmlns=""https://www.google.com/apis/ads/publisher/v202608"">
        ...
        public void TestAdManagerApiExceptionForFault()
        {
            SoapFaultInspector<AdManagerApiException> inspector =
                new SoapFaultInspector<AdManagerApiException>()
                {
                    ErrorType = typeof(AdManager.v202608.ApiException)
                };
