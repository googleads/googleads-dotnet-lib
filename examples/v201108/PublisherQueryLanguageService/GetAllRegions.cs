...
namespace Google.Api.Ads.Dfp.Examples.v201108 {
  ...
  class GetAllRegions : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example gets all regions available to target.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllRegions();
    ...
    public override void Run(DfpUser user) {
      ...
      try {
        ...
        Console.WriteLine("Failed to get all regions. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
