...
namespace Google.Api.Ads.Dfp.Examples.v201108 {
  /// <summary>
  /// This code example gets all bandwidth groups.
  ///
  /// Tags: PublisherQueryLanguageService.select
  /// </summary>
  class GetAllBandwidthGroups : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all bandwidth groups.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllBandwidthGroups();
    ...
    public override void Run(DfpUser user) {
      ...
      try {
        ...
        Console.WriteLine("Failed to get all bandwidth groups. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
