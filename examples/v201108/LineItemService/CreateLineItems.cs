...
namespace Google.Api.Ads.Dfp.Examples.v201108 {
  ...
  class CreateLineItems : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example creates new line items. To determine which line items " +
            ...
            "IDs for locations, run GetAllCities.cs, GetAllCountries.cs, GetAllMetros.cs, and " +
            "GetAllRegions.cs.";
      }
    }
    ...
    public override void Run(DfpUser user) {
      ...
      saturdayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201108.DayOfWeek.SATURDAY;
      ...
      sundayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201108.DayOfWeek.SUNDAY;
