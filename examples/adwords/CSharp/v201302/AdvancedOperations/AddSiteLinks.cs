...
namespace Google.Api.Ads.AdWords.Examples.CSharp.v201302 {
  ...
  public class AddSiteLinks : ExampleBase {
    ...
    private static void createSiteLinksFeed(
      ...
      // Get the FeedService.
      FeedService feedService = (FeedService) user.GetService(AdWordsService.v201302.FeedService);
    ...
    private static void createSiteLinksFeedItems(
      ...
      FeedItemService feedItemService =
        (FeedItemService) user.GetService(AdWordsService.v201302.FeedItemService);
    ...
    private static void createSiteLinksFeedMapping(
      ...
      FeedMappingService feedMappingService =
        (FeedMappingService) user.GetService(AdWordsService.v201302.FeedMappingService);
    ...
    private static void createSiteLinksCampaignFeed(AdWordsUser user,
      ...
      CampaignFeedService campaignFeedService =
        (CampaignFeedService) user.GetService(AdWordsService.v201302.CampaignFeedService);
