  ...
  Public Class AddCampaigns
    ...
    Public Sub Run(ByVal user As AdWordsUser)
      ...
      Dim budgetService As BudgetService = user.GetService( _
          AdWordsService.v201209.BudgetService)
      ...
      For i As Integer = 1 To NUM_ITEMS
        ...
        Dim displaySetting As New TargetRestrictSetting()
        displaySetting.useAdGroup = True

        campaign.settings = New Setting() {geoSetting, keywordSetting, displaySetting}
