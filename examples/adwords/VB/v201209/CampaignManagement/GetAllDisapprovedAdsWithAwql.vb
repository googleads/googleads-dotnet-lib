...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201209
  ...
  Public Class GetAllDisapprovedAdsWithAwql
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      ...
      Dim service As AdGroupAdService = user.GetService(AdWordsService.v201209.AdGroupAdService)

      ' Get all the disapproved ads for this campaign.
      Dim query As String = String.Format("SELECT Id, DisapprovalReasons WHERE CampaignId = " & _
          "{0} AND AdGroupCreativeApprovalStatus = DISAPPROVED ORDER BY Id", campaignId)
