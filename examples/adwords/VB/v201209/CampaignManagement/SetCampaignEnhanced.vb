...
Imports System.IO
Imports Google.Api.Ads.AdWords.Util.v201209

Namespace Google.Api.Ads.AdWords.Examples.VB.v201209
  ''' <summary>
  ''' This code example sets the enhanced bit in a given campaign using the
  ''' forward compatibility map attribute. To get campaigns, run
  ''' GetCampaigns.vb.
  '''
  ...
  Public Class SetCampaignEnhanced
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      ...
      Dim mapUtils As New MapUtilities
      ...
      campaign.forwardCompatibilityMap = mapUtils.Add("Campaign.enhanced", "true").AsArray()
      ...
      Try
        ...
        If Not result.value Is Nothing Then
          ...
          Dim compatMap As Dictionary(Of String, String) = _
              New MapUtilities().AddEntries(updatedCampaign.forwardCompatibilityMap).AsDict()

          Console.WriteLine("Campaign with ID {0} has been set enhanced to '{1}'.", _
              updatedCampaign.id, compatMap("Campaign.enhanced"))
        Else
