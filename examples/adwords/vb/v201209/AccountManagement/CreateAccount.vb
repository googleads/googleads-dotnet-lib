...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201209
  ...
  Public Class CreateAccount
    ...
    Public Sub Run(ByVal user As AdWordsUser)
      ...
      Dim managedCustomerService As ManagedCustomerService = user.GetService(AdWordsService.v201209.ManagedCustomerService)
  ...
  Class ManagedCustomerTreeNode
    ...
    Public Overrides Function ToString() As String
      Dim login As String = "(no login)"
      If (Not String.IsNullOrEmpty(_account.login)) Then
        login = _account.login
      End If
      Return String.Format("{0}, {1}, {2}", login, _account.customerId, _account.name)
    End Function
