...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201409
  ...
  Public Class RemoveAdGroup
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal adGroupId As Long)
      ...
      Dim adGroupService As AdGroupService = user.GetService(AdWordsService.v201409.AdGroupService)
      ...
      Try
        ...
        End If
      Catch ex As Exception
        Throw New System.ApplicationException("Failed to remove ad groups.", ex)
      End Try
    End Sub
  End Class
End Namespace
