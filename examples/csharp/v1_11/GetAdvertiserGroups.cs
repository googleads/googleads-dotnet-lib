...
namespace Google.Api.Ads.Dfa.Examples.CSharp.v1_11 {
  /// <summary>
  /// This code example displays advertiser group name, id, and advertiser count
  /// for the given search criteria. Results are limited to the first 10
  /// records.
  /// </summary>
  class GetAdvertiserGroups : SampleBase {
    ...
    public override void Run(DfaUser user) {
      ...
      AdvertiserGroupRemoteService service = (AdvertiserGroupRemoteService) user.GetService(
          DfaService.v1_11.AdvertiserGroupRemoteService);
