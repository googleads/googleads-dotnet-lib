...
using Google.Api.Ads.AdManager.Util.v202511;
using Google.Api.Ads.AdManager.v202511;

using System;
using System.Collections.Generic;

namespace Google.Api.Ads.AdManager.Examples.CSharp.v202511
{
    /// <summary>
    ...
    /// </summary>
    public class CreatePlacements : SampleBase
    {
        /// <summary>
        ...
        {
            CreatePlacements codeExample = new CreatePlacements();
            ...
            using (InventoryService inventoryService = user.GetService<InventoryService>())
                ...
                using (PlacementService placementService = user.GetService<PlacementService>())
                {
                    ...
                    skyscraperAdUnitPlacement.name =
                        string.Format("Skyscraper AdUnit Placement #{0}", this.GetTimeStamp());
                    ...
                    mediumSquareAdUnitPlacement.name =
                        string.Format("Medium Square AdUnit Placement #{0}", this.GetTimeStamp());
                    ...
                    try
                    {
                        ...
                        mediumSquareAdUnitPlacement.targetedAdUnitIds =
                            mediumSquareTargetedUnitIds.ToArray();
                        skyscraperAdUnitPlacement.targetedAdUnitIds =
                            skyscraperTargetedUnitIds.ToArray();
                        ...
                        if (placements != null)
                        {
                            ...
                            {
                                Console.Write(
                                    "A placement with ID = '{0}', name ='{1}', and containing " +
