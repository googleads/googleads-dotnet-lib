...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v201808
{
    ...
    /// </summary>
    public class CreateContentMetadataKeyHierarchies : SampleBase
    {
        /// <summary>
        ...
        {
            CreateContentMetadataKeyHierarchies codeExample =
                new CreateContentMetadataKeyHierarchies();
        ...
        public void Run(AdManagerUser user)
        {
                ...
                user.GetService<ContentMetadataKeyHierarchyService>())
            {
                ...
                ContentMetadataKeyHierarchyLevel hierarchyLevel1 =
                ...
                ContentMetadataKeyHierarchyLevel hierarchyLevel2 =
                    new ContentMetadataKeyHierarchyLevel();
                ...
                contentMetadataKeyHierarchy.name =
                    "Content hierarchy #" + new Random().Next(int.MaxValue);
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine(
                            "A content metadata key hierarchy with ID \"{0}\", name " +
                            "\"{1}\" and {2} levels was created.",
                            createdContentMetadataKeyHierarchy.id,
                ...
                {
                    Console.WriteLine(
                        "Failed to create content metadata key hierarchies. Exception says " +
                        "\"{0}\"", e.Message);
                }
            }
        }
