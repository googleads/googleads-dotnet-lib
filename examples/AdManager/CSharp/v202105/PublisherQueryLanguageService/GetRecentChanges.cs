...
using DateTime = Google.Api.Ads.AdManager.v202105.DateTime;
...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202105
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v202105/PublisherQueryLanguageService
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This example gets recent changes in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v202105/" +
