...
using DateTime = Google.Api.Ads.AdManager.v202008.DateTime;
...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202008
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v202008/PublisherQueryLanguageService
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This example gets recent changes in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v202008/" +
