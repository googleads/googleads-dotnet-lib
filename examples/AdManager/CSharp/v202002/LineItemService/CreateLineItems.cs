    ...
    public class CreateLineItems : SampleBase
    {
        ...
        public void Run(AdManagerUser user)
        {
            using (LineItemService lineItemService = user.GetService<LineItemService>())
            {
                ...
                saturdayDayPart.dayOfWeek = Google.Api.Ads.AdManager.v202002.DayOfWeek.SATURDAY;
                ...
                sundayDayPart.dayOfWeek = Google.Api.Ads.AdManager.v202002.DayOfWeek.SUNDAY;
