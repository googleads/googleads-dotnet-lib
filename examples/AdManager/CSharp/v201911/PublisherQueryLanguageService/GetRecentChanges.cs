...
using DateTime = Google.Api.Ads.AdManager.v201911.DateTime;
...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v201911
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v201911/PublisherQueryLanguageService
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This example gets recent changes in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v201911/" +
