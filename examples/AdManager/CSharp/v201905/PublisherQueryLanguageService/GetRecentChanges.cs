...
using DateTime = Google.Api.Ads.AdManager.v201905.DateTime;
...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v201905
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v201905/PublisherQueryLanguageService
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This example gets recent changes in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v201905/" +
