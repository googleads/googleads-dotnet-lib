...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202108
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v202108/PublisherQueryLanguageService#Line_Item
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This code example gets all line items in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v202108/" +
