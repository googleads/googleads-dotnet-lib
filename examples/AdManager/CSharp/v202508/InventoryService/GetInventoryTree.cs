...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202508
{
    ...
    public class GetInventoryTree : SampleBase
    {
        ...
        public override string Description
        {
            ...
            {
                return
                    "This code example retrieves a previously created ad units and creates a tree.";
            }
        }
        ...
        private static AdUnit[] GetAllAdUnits(AdManagerUser user)
        {
        ...
        private static AdUnit FindRootAdUnit(AdManagerUser user)
        {
            using (InventoryService inventoryService = user.GetService<InventoryService>())
            {
        ...
        private static void DisplayInventoryTree(AdUnit root,
            Dictionary<String, List<AdUnit>> treeMap)
        {
