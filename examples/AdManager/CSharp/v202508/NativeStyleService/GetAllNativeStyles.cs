...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202508
{
    ...
    public class GetAllNativeStyles : SampleBase
    {
        ...
        {
            get { return "This example gets all native styles."; }
        }
        ...
        public static void Main()
        {
            ...
            {
                Console.WriteLine("Failed to get native styles. Exception says \"{0}\"", e.Message);
            }
        }
            ...
            using (NativeStyleService NativeStyleService = user.GetService<NativeStyleService>())
            {
                ...
                do
                {
                    NativeStylePage page =
                        NativeStyleService.getNativeStylesByStatement(
                    ...
                    if (page.results != null)
                    {
                        ...
                        {
                            Console.WriteLine(
                                "{0}) Native style with ID {1} and name \"{2}\" was found.", i++,
                                nativeStyle.id, nativeStyle.name);
                        }
                    }
