...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202508
{
    ...
    public class GetPredefinedCustomTargetingKeysAndValues : SampleBase
    {
        ...
        {
            get { return "This example gets predefined custom targeting keys and values."; }
        }
        ...
        public void Run(AdManagerUser user)
        {
                ...
                user.GetService<CustomTargetingService>())
            {
                ...
                List<long> customTargetingKeyIds = 
                    getPredefinedCustomTargetingKeyIds(user);
        ...
        private List<long> getPredefinedCustomTargetingKeyIds(AdManagerUser user)
        {
