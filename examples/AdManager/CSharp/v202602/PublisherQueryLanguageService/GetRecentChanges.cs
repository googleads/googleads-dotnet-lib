...
using DateTime = Google.Api.Ads.AdManager.v202602.DateTime;
...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202602
{
    ...
    /// https://developers.google.com/doubleclick-publishers/docs/reference/v202602/PublisherQueryLanguageService
    /// </summary>
        ...
        public override string Description
        {
            get
            {
                return "This example gets recent changes in your network using the " +
                    ...
                    "https://developers.google.com/doubleclick-publishers/docs/reference/v202602/" +
