...
namespace Google.Api.Ads.Dfp.Examples.v201204 {
  /// <summary>
  /// This code example gets all third party slots. To create third party slots,
  /// run CreateThirdPartySlot.cs.
  ///
  /// Tags: ThirdPartSlotsService.getThirdPartySlotsByStatement
  /// </summary>
  class GetAllThirdPartySlots : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all third party slots. To create third party slots, " +
            "run CreateThirdPartySlot.cs.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllThirdPartySlots();
    ...
    public override void Run(DfpUser user) {
      ...
      ThirdPartySlotService thirdPartySlotService =
          (ThirdPartySlotService) user.GetService(DfpService.v201204.ThirdPartySlotService);
