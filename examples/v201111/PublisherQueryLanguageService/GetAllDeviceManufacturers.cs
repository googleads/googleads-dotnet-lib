...
namespace Google.Api.Ads.Dfp.Examples.v201111 {
  /// <summary>
  /// This code example gets all device manufacturers.
  ///
  /// Tags: PublisherQueryLanguageService.select
  /// </summary>
  class GetAllDeviceManufacturers : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all device manufacturers.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllDeviceManufacturers();
    ...
    public override void Run(DfpUser user) {
      ...
      StatementBuilder statementBuilder = new StatementBuilder("SELECT * FROM Device_Manufacturer");
      ...
      try {
        ...
        Console.WriteLine("Failed to get all device manufacturers. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
