...
namespace Google.Api.Ads.Dfp.Examples.v201111 {
  /// <summary>
  /// This code example gets all operating system versions.
  ///
  /// Tags: PublisherQueryLanguageService.select
  /// </summary>
  class GetAllOperatingSystemVersions : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all operating system versions.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllOperatingSystemVersions();
    ...
    public override void Run(DfpUser user) {
      ...
      try {
        ...
        Console.WriteLine("Failed to get all operating system versions. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
