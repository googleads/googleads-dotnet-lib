...
namespace Google.Api.Ads.Dfp.Examples.v201111 {
  /// <summary>
  /// This code example gets all postal codes.
  ///
  /// Tags: PublisherQueryLanguageService.select
  /// </summary>
  class GetAllPostalCodes : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all postal codes.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllPostalCodes();
    ...
    public override void Run(DfpUser user) {
      ...
      StatementBuilder statementBuilder = new StatementBuilder("SELECT * FROM Postal_Code");
      ...
      try {
        ...
        Console.WriteLine("Failed to get all postal codes. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
