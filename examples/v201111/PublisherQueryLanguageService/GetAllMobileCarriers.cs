...
namespace Google.Api.Ads.Dfp.Examples.v201111 {
  /// <summary>
  /// This code example gets all mobile carriers.
  ///
  /// Tags: PublisherQueryLanguageService.select
  /// </summary>
  class GetAllMobileCarriers : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all mobile carriers.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetAllMobileCarriers();
    ...
    public override void Run(DfpUser user) {
      ...
      StatementBuilder statementBuilder = new StatementBuilder("SELECT * FROM Mobile_Carrier");
      ...
      try {
        ...
        Console.WriteLine("Failed to get all mobile carriers. Exception says \"{0}\"",
            ex.Message);
      }
    }
  }
