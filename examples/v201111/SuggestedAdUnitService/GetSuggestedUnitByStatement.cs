...
namespace Google.Api.Ads.Dfp.Examples.v201111 {
  /// <summary>
  /// This code example gets suggested ad units that have exactly 10 requests.
  ...
  class GetSuggestedUnitByStatement : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example gets suggested ad units that have exactly 10 requests. The " +
    ...
    public override void Run(DfpUser user) {
      ...
      Statement filterStatement = new StatementBuilder("WHERE numRequests = :numRequests LIMIT 500")
          .AddValue("numRequests", 10).ToStatement();
