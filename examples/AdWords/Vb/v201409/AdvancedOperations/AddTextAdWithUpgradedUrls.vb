  ...
  Public Class AddTextAdWithUpgradedUrls
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal adGroupId As Long)
      ...
      Dim service As AdGroupAdService = CType(user.GetService( _
          AdWordsService.v201409.AdGroupAdService), AdGroupAdService)
      ...
      Try
        ...
        If Not (retVal Is Nothing) AndAlso Not (retVal.value Is Nothing) Then
          ...
          Dim newTextAd As TextAd = CType(newAdGroupAd.ad, AdWords.v201409.TextAd)
        ...
        End If
      Catch ex As Exception
        Throw New System.ApplicationException("Failed to add ad to adgroup.", ex)
      End Try
    End Sub
  End Class
