  ...
  Public Class AddSitelinks
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      ...
      Dim campaignExtensionSettingService As CampaignExtensionSettingService = _
          DirectCast(user.GetService(AdWordsService.v201409.CampaignExtensionSettingService),  _
                                    CampaignExtensionSettingService)

      Dim customerService As CustomerService = _
          DirectCast(user.GetService(AdWordsService.v201409.CustomerService),  _
                                    CustomerService)
      ...
      schedule1.dayOfWeek = AdWords.v201409.DayOfWeek.MONDAY
      ...
      schedule2.dayOfWeek = AdWords.v201409.DayOfWeek.TUESDAY
      ...
      schedule3.dayOfWeek = AdWords.v201409.DayOfWeek.WEDNESDAY
      ...
      schedule4.dayOfWeek = AdWords.v201409.DayOfWeek.THURSDAY
      ...
      schedule5.dayOfWeek = AdWords.v201409.DayOfWeek.FRIDAY
