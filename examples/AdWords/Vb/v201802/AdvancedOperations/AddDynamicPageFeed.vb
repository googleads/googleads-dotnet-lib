    ...
    Public Class AddDynamicPageFeed
        ...
        Public Overrides ReadOnly Property Description() As String
            Get
                Return _
                    ...
                    "campaign, run AddDynamicSearchAdsCampaign.vb. To get campaigns, " +
                    "run GetCampaigns.vb."
            End Get
        End Property
        ...
        Private Sub CreateFeedMapping(ByVal user As AdWordsUser,
            ...
            Using feedMappingService As FeedMappingService = CType(
                user.GetService(
                    AdWordsService.v201802.FeedMappingService),
                FeedMappingService)
        ...
        Private Sub CreateFeedItems(ByVal user As AdWordsUser, ByVal feedDetails As DSAFeedDetails,
            ...
            Using feedItemService As FeedItemService = CType(
                ...
                Dim operations() As FeedItemOperation =
                        { _
                            CreateDsaUrlAddOperation(feedDetails, rentalCarsUrl, labelName),
                            CreateDsaUrlAddOperation(feedDetails, hotelDealsUrl, labelName),
                            CreateDsaUrlAddOperation(feedDetails, flightDealsUrl, labelName)
                        }
