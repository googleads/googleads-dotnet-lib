                ...
                Dim userIdentifierList1 As UserIdentifier() =
                    { _
                        CreateUserIdentifier(
                            OfflineDataUploadUserIdentifierType.HASHED_EMAIL,emailAddresses(0)),
                        CreateUserIdentifier(
                            OfflineDataUploadUserIdentifierType.STATE, "New York")
                    }
                ...
                Dim userIdentifierList2 As UserIdentifier() =
                    { _
                        CreateUserIdentifier(OfflineDataUploadUserIdentifierType.HASHED_EMAIL,
                                             emailAddresses(1)),
                        CreateUserIdentifier(OfflineDataUploadUserIdentifierType.STATE,
                                             "California")
                    }
                    ...
                    If Not result.partialFailureErrors Is Nothing Then
                        For Each apiError As ApiError In result.partialFailureErrors
                            ...
                            If operationIndex <> - 1 Then
                                ...
                                ' Get the index of the entry in the offline data list from
                                ' the error's field path elements.
