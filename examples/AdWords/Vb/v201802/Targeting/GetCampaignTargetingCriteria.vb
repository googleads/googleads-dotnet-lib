...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201802
    ...
    Public Class GetCampaignTargetingCriteria
        ...
        Public Overrides ReadOnly Property Description() As String
            Get
                Return _
                    "This code example gets all targeting criteria for a campaign.  To set campaign " &
                    "targeting criteria, run AddCampaignTargetingCriteria.vb. To get campaigns, run " &
                    "GetCampaigns.vb."
            End Get
        End Property
        ...
        Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
            Using campaignCriterionService As CampaignCriterionService = CType(
                    ...
                    Do
                        ...
                        If ((Not page Is Nothing) AndAlso (Not page.entries Is Nothing)) Then
                            For Each campaignCriterion As CampaignCriterion In page.entries
                                ...
                                End If
                                Console.WriteLine(
                                    "{0}) {1}Campaign targeting criterion with id = '{2}' and " &
                ...
                Catch e As Exception
                    Throw _
                        New System.ApplicationException("Failed to get campaign targeting criteria.",
                                                        e)
                End Try
            End Using
        End Sub
