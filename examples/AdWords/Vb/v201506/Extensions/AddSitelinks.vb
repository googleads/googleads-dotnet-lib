  ...
  Public Class AddSitelinks
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      ...
      Dim campaignExtensionSettingService As CampaignExtensionSettingService = _
          DirectCast(user.GetService(AdWordsService.v201506.CampaignExtensionSettingService),  _
                                    CampaignExtensionSettingService)

      Dim customerService As CustomerService = _
          DirectCast(user.GetService(AdWordsService.v201506.CustomerService),  _
                                    CustomerService)
      ...
      schedule1.dayOfWeek = AdWords.v201506.DayOfWeek.MONDAY
      ...
      schedule2.dayOfWeek = AdWords.v201506.DayOfWeek.TUESDAY
      ...
      schedule3.dayOfWeek = AdWords.v201506.DayOfWeek.WEDNESDAY
      ...
      schedule4.dayOfWeek = AdWords.v201506.DayOfWeek.THURSDAY
      ...
      schedule5.dayOfWeek = AdWords.v201506.DayOfWeek.FRIDAY
