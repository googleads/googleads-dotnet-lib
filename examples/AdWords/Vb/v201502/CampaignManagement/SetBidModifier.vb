  ...
  Public Class SetBidModifier
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long, ByVal bidModifier As Double)
      ...
      Dim campaignCriterionService As CampaignCriterionService = CType(user.GetService( _
          AdWordsService.v201502.CampaignCriterionService),  _
          AdWords.v201502.CampaignCriterionService)
      ...
      Try
        ...
        End If
      Catch ex As Exception
        Throw New System.ApplicationException("Failed to set bid modifier.", ex)
      End Try
    End Sub
  End Class
End Namespace