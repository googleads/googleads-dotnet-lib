...
Imports Google.Api.Ads.AdWords.v201609

Imports System
Imports System.Collections.Generic
Imports System.IO

Imports DayOfWeek = Google.Api.Ads.AdWords.v201609.DayOfWeek

Namespace Google.Api.Ads.AdWords.Examples.VB.v201609
  ...
  Public Class AddPrices
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      ...
      Dim customerExtensionSettingService As CustomerExtensionSettingService = _
          DirectCast(user.GetService(AdWordsService.v201609.CustomerExtensionSettingService),  _
    ...
    Private Shared Function CreatePriceTableRow(ByVal header As String, _
        ByVal description As String, ByVal finalUrl As String, ByVal priceInMicros As Long, _
        ByVal currencyCode As String, ByVal priceUnit As PriceExtensionPriceUnit) As PriceTableRow
