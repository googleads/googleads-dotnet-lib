        ...
        Public Sub Run(ByVal user As AdWordsUser, ByVal draftId As Long,
            ...
            Using trialService As TrialService = CType(
                ...
                Using trialAsyncErrorService As TrialAsyncErrorService =
                    CType(user.GetService(AdWordsService.v201806.TrialAsyncErrorService),
                    ...
                    Try
                        ...
                        trialSelector.fields =
                            New String() { _
                                             Trial.Fields.Id, Trial.Fields.Status,
                        ...
                        If newTrial.status = TrialStatus.ACTIVE Then
                            ...
                            Console.WriteLine(
                                "Trial created with ID {0} and trial campaign ID {1}.",
