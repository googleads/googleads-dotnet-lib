  ...
  Public Class AddSitelinksUsingFeeds
    ...
    Private Sub RestrictFeedItemToAdGroup(user As AdWordsUser,
      ...
      Using feedItemTargetService As FeedItemTargetService = CType(user.GetService(
          AdWordsService.v201806.FeedItemTargetService), FeedItemTargetService)
    ...
    Private Shared Sub RestrictFeedItemToGeoTarget(ByVal user As AdWordsUser,
        ByVal feedItem As FeedItem, ByVal locationId As Long)
    ...
    Private Sub CreateSitelinksFeed(
      ...
      Using feedService As FeedService = CType(user.GetService(
          AdWordsService.v201806.FeedService), FeedService)
    ...
    Private Sub CreateSitelinksFeedItems(
      ...
      Using feedItemService As FeedItemService = CType(user.GetService(
          AdWordsService.v201806.FeedItemService), FeedItemService)
        ...
        Dim aboutUs As FeedItemOperation = NewSitelinkFeedItemAddOperation(sitelinksData,
          "About Us", "http://www.example.com/about", "About Us line 2", "About Us line 3", True)
    ...
    Private Sub CreateSitelinksFeedMapping(
      ...
      Using feedMappingService As FeedMappingService = CType(user.GetService(
          AdWordsService.v201806.FeedMappingService), FeedMappingService)
    ...
    Private Sub CreateSitelinksCampaignFeed(ByVal user As AdWordsUser,
      ...
      Using campaignFeedService As CampaignFeedService = CType(user.GetService(
          AdWordsService.v201806.CampaignFeedService), CampaignFeedService)
    ...
    Function NewSitelinkFeedItemAddOperation(ByVal sitelinksData As SitelinksDataHolder,
        ByVal text As String, ByVal finalUrl As String, ByVal line2 As String,
        ByVal line3 As String, ByVal targetLop As Boolean) _
