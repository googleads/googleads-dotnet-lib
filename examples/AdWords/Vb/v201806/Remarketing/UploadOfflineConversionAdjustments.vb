...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201806
  ...
  Public Class UploadOfflineConversionAdjustments
      ...
      Try
        ...
        Dim adjustmentType As OfflineConversionAdjustmentType =
            DirectCast([Enum].Parse(GetType(OfflineConversionAdjustmentType),
                "INSERT_ADJUSTMENT_TYPE_HERE"), OfflineConversionAdjustmentType)
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal conversionName As String,
        ...
        ByVal adjustmentType As OfflineConversionAdjustmentType, ByVal adjustmentTime As String,
        ByVal adjustedValue As Double)
      Using service As OfflineConversionAdjustmentFeedService = CType(user.GetService(
