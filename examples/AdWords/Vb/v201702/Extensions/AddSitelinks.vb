...
Imports DayOfWeek = Google.Api.Ads.AdWords.v201702.DayOfWeek
    ...
    Public Sub Run(ByVal user As AdWordsUser, ByVal campaignId As Long)
      Using campaignExtensionSettingService As CampaignExtensionSettingService =
        ...
        Dim customerService As CustomerService =
            DirectCast(user.GetService(AdWordsService.v201702.CustomerService),
                CustomerService)
        ...
        sitelink4.scheduling = New FeedItemSchedule() {
