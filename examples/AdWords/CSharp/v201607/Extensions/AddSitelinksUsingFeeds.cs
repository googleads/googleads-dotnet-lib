...
namespace Google.Api.Ads.AdWords.Examples.CSharp.v201607 {
  ...
  public class AddSitelinksUsingFeeds : ExampleBase {
    ...
    private static void createSitelinksFeed(AdWordsUser user, SitelinksDataHolder sitelinksData,
        string feedName) {
      // Get the FeedService.
      FeedService feedService = (FeedService) user.GetService(AdWordsService.v201607.FeedService);
    ...
    private static void createSitelinksFeedItems(
      ...
      FeedItemService feedItemService =
        (FeedItemService) user.GetService(AdWordsService.v201607.FeedItemService);
    ...
    private static void createSitelinksFeedMapping(
      ...
      FeedMappingService feedMappingService =
        (FeedMappingService) user.GetService(AdWordsService.v201607.FeedMappingService);
    ...
    private static void createSitelinksCampaignFeed(AdWordsUser user,
      ...
      CampaignFeedService campaignFeedService =
        (CampaignFeedService) user.GetService(AdWordsService.v201607.CampaignFeedService);
