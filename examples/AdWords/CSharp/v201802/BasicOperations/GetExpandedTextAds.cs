...
namespace Google.Api.Ads.AdWords.Examples.CSharp.v201802
{
    ...
    public class GetExpandedTextAds : ExampleBase
    {
        ...
        public override string Description
        {
            get
            {
                return "This code example retrieves all expanded text ads given an existing " +
                    "ad group. To add expanded text ads to an existing ad group, " +
                ...
                (AdGroupAdService) user.GetService(AdWordsService.v201802.AdGroupAdService))
            {
                ...
                Selector selector = new Selector()
                {
                    fields = new string[]
                    {
                        ...
                        ExpandedTextAd.Fields.SystemManagedEntitySource
                    },
