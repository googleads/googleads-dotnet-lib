  ...
  public class AddPromotion : ExampleBase {
    ...
    public void Run(AdWordsUser user, long businessId) {
      ...
      PromotionService promotionService = (PromotionService)
          user.GetService(AdWordsService.v201609.PromotionService);
      ...
      // Expanded creative
      ExpandedCreative expandedCreative = new ExpandedCreative();
      expandedCreative.headline1 = "Standard Mars Trip";
      expandedCreative.headline2 = "Fly coach to Mars";
      expandedCreative.description = "Free in-flight pretzels";
