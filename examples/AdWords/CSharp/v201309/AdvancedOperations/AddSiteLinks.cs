...
namespace Google.Api.Ads.AdWords.Examples.CSharp.v201309 {
  ...
  public class AddSiteLinks : ExampleBase {
    ...
    private static void createSiteLinksFeed(
      ...
      // Get the FeedService.
      FeedService feedService = (FeedService) user.GetService(AdWordsService.v201309.FeedService);
    ...
    private static void createSiteLinksFeedItems(
      ...
      FeedItemService feedItemService =
        (FeedItemService) user.GetService(AdWordsService.v201309.FeedItemService);
    ...
    private static void createSiteLinksFeedMapping(
      ...
      FeedMappingService feedMappingService =
        (FeedMappingService) user.GetService(AdWordsService.v201309.FeedMappingService);
    ...
    private static void createSiteLinksCampaignFeed(AdWordsUser user,
      ...
      CampaignFeedService campaignFeedService =
        (CampaignFeedService) user.GetService(AdWordsService.v201309.CampaignFeedService);
