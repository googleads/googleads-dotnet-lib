...
namespace Google.Api.Ads.Dfp.Examples.v201103 {
  ...
  class CreateLineItems : SampleBase {
    ...
    public override void Run(DfpUser user) {
      ...
      CountryLocation location1 = new CountryLocation();
      location1.countryCode = "US";

      RegionLocation location2 = new RegionLocation();
      location2.regionCode = "CA-QC";

      geoTargeting.targetedLocations = new Location[] {location1, location2};

      // Exclude Chicago and the New York metro area.
      CityLocation exLocation1 = new CityLocation();
      exLocation1.cityName = "Chicago";
      exLocation1.countryCode = "US";

      MetroLocation exLocation2 = new MetroLocation();
      exLocation2.metroCode = "501";
      geoTargeting.excludedLocations = new Location[] {exLocation1, exLocation2};
      ...
      saturdayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201103.DayOfWeek.SATURDAY;
      ...
      sundayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201103.DayOfWeek.SUNDAY;
