...
namespace Google.Api.Ads.Dfa.Examples.v1_11 {
  ...
  /// tag methods types, run GetTagMethodTypes.cs. To get activity type ids, run
  /// GetActivityTypes.cs. To get available countries, run GetCountries.cs.
  /// </summary>
  class CreateSpotlightActivity : SampleBase {
    ...
    public override void Run(DfaUser user) {
      ...
      SpotlightRemoteService service = (SpotlightRemoteService) user.GetService(
          DfaService.v1_11.SpotlightRemoteService);
