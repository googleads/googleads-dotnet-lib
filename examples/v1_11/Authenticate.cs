...
namespace Google.Api.Ads.Dfa.Examples.v1_11 {
  /// <summary>
  /// This code example authenticates using your DFA user name and password, and
  /// displays the user profile token, DFA account name and id. If you are
  ...
  class Authenticate : SampleBase {
    ...
    public override void Run(DfaUser user) {
      ...
      LoginRemoteService service = (LoginRemoteService) user.GetService(
          DfaService.v1_11.LoginRemoteService);
