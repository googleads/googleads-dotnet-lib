...
namespace Google.Api.Ads.Dfa.Examples.v1_11 {
  ...
  /// campaign start and end dates. To create creatives, run CreateCreatives.cs.
  /// To get available placements, run GetPlacement.cs. To get a size id, run
  /// GetSize.cs.
  /// </summary>
  class CreateRotationGroup : SampleBase {
    ...
    public override void Run(DfaUser user) {
      ...
      AdRemoteService service = (AdRemoteService) user.GetService(
          DfaService.v1_11.AdRemoteService);
