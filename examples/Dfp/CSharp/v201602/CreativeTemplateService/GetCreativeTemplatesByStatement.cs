...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201602 {
  ...
  /// </summary>
  public class GetCreativeTemplatesByStatement : SampleBase {
    /// <summary>
    ...
    public static void Main() {
      GetCreativeTemplatesByStatement codeExample = new GetCreativeTemplatesByStatement();
    ...
    public void Run(DfpUser user) {
      ...
      CreativeTemplateService creativeTemplateService =
          (CreativeTemplateService) user.GetService(DfpService.v201602.CreativeTemplateService);
