  ...
  public class TriggerWorkflowExternalConditionRequests : SampleBase {
    ...
    public void Run(DfpUser user) {
      ...
      WorkflowRequestService proposalLineItemService =
          (WorkflowRequestService) user.GetService(DfpService.v201702.WorkflowRequestService);
      ...
      try {
        ...
        if (workflowRequestIds.Count > 0) {
          ...
          // Create action.
          Google.Api.Ads.Dfp.v201702.TriggerWorkflowExternalConditionRequests action =
              new Google.Api.Ads.Dfp.v201702.TriggerWorkflowExternalConditionRequests();
