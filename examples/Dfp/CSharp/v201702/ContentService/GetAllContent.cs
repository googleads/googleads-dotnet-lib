...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201702 {
  ...
  public class GetAllContent : SampleBase {
    ...
    public void Run(DfpUser dfpUser) {
      using (ContentService contentService =
          (ContentService) dfpUser.GetService(DfpService.v201702.ContentService)) {
        ...
        do {
          ContentPage page = contentService.getContentByStatement(
          ...
          if (page.results != null) {
            ...
            foreach (Content content in page.results) {
              Console.WriteLine(
                  "{0}) Content with ID {1} and name \"{2}\" was found.",
                  i++,
                  content.id,
                  content.name
              );
