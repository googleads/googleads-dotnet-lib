...
using DateTime = Google.Api.Ads.Dfp.v201711.DateTime;
...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201711 {
  ...
  public class GetRecentChanges : SampleBase {
    ...
    public override string Description {
      get {
        return "This example gets recent changes in your network using the Change_History table. " +
            "A full list of available tables can be found at " +
            "https://developers.google.com/doubleclick-publishers/docs/reference/v201711/PublisherQueryLanguageService";
      }
    }
    ...
    public void Run(DfpUser user) {
      using (PublisherQueryLanguageService pqlService =
          (PublisherQueryLanguageService) user.GetService(
              DfpService.v201711.PublisherQueryLanguageService)) {
