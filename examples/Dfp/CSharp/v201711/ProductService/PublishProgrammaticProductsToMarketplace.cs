  ...
  public class PublishProgrammaticProductsToMarketplace : SampleBase {
    ...
    public void Run(DfpUser user, long productId) {
      using (ProductService productService =
          (ProductService) user.GetService(DfpService.v201711.ProductService)) {
        ...
        try {
          ...
          if (productIds.Count > 0) {
            ...
            // Create action.
            Google.Api.Ads.Dfp.v201711.PublishProducts action =
                new Google.Api.Ads.Dfp.v201711.PublishProducts();
