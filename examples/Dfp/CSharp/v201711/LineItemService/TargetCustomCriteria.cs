...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201711 {
  ...
  public class TargetCustomCriteria : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example updates a line item to add custom criteria targeting. To " +
            "determine which line items exist, run GetAllLineItems.cs. To determine which " +
            "custom targeting keys and values exist, run GetAllCustomTargetingKeysAndValues.cs.";
      }
    }
    ...
    public void Run(DfpUser user) {
      using (LineItemService lineItemService = (LineItemService) user.GetService(
          DfpService.v201711.LineItemService)) {
        ...
        try {
          ...
          LineItem[] updatedLineItems = lineItemService.updateLineItems(
