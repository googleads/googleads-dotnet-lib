...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201711 {
  ...
  public class CreateProgrammaticProposals : SampleBase {
    ...
    public override string Description {
      get {
        return "This example creates a programmatic proposal. Your network must have sales "
    ...
    public static void Main() {
      ...
      codeExample.Run(new DfpUser(), advertiserId, buyerId, primarySalespersonId,
          primaryTraffickerId);
    }
    ...
    public void Run(DfpUser user, long advertiserId, long buyerId, long primarySalespersonId,
      ...
      using (ProposalService proposalService =
          (ProposalService) user.GetService(DfpService.v201711.ProposalService))
