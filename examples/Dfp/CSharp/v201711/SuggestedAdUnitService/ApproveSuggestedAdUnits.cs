    ...
    public void Run(DfpUser user) {
      using (SuggestedAdUnitService suggestedAdUnitService =
          (SuggestedAdUnitService) user.GetService(
              DfpService.v201711.SuggestedAdUnitService)) {
        ...
        try {
          ...
          // Create action.
          Google.Api.Ads.Dfp.v201711.ApproveSuggestedAdUnits action =
              new Google.Api.Ads.Dfp.v201711.ApproveSuggestedAdUnits();
