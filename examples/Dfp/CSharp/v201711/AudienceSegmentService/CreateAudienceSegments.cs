  ...
  public class CreateAudienceSegments : SampleBase {
    ...
    public void Run(DfpUser user) {
      using (AudienceSegmentService audienceSegmentService =
          (AudienceSegmentService) user.GetService(DfpService.v201711.AudienceSegmentService)) {

        // Get the NetworkService.
        NetworkService networkService = (NetworkService) user.GetService(
            DfpService.v201711.NetworkService);
        ...
        try {
          ...
          foreach (AudienceSegment createdAudienceSegment in audienceSegments) {
            Console.WriteLine("An audience segment with ID \"{0}\", name \"{1}\", and " +
