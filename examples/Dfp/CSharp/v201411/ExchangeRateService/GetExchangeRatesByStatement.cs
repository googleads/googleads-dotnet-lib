...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201411 {
  ...
  /// </summary>
  class GetExchangeRatesByStatement : SampleBase {
    /// <summary>
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetExchangeRatesByStatement();
    ...
    public override void Run(DfpUser user) {
      ...
      ExchangeRateService exchangeRateService =
          (ExchangeRateService) user.GetService(DfpService.v201411.ExchangeRateService);
