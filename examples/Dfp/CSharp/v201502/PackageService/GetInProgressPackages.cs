...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201502 {
  /// <summary>
  /// This code example gets all packages that are IN_PROGRESS. To create packages, run
  /// CreatePackages.cs.
  ///
  /// Tags: PackageService.getPackagesByStatement
  /// </summary>
  class GetInProgressPackages : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all packages that are in progress. To create " +
            "packages, run CreatePackages.cs.";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetInProgressPackages();
