...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201502 {
  ...
  ///
  /// Tags: PremiumRateService.getPremiumRatesByStatement, PremiumRateService.updatePremiumRates
  /// </summary>
  class UpdatePremiumRates : SampleBase {
    ...
    public override void Run(DfpUser user) {
      ...
      PremiumRateService premiumRateService =
          (PremiumRateService) user.GetService(DfpService.v201502.PremiumRateService);
