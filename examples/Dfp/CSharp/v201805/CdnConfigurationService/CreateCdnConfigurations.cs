...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201805 {
  ...
  public class CreateCdnConfigurations : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example creates new CDN configurations.";
      }
    }
    ...
    public void Run(DfpUser user) {
      using (CdnConfigurationService cdnConfigurationService =
          (CdnConfigurationService)user.GetService(DfpService.v201805.CdnConfigurationService)) {
        ...
        try {
          ...
          foreach(CdnConfiguration createdCdnConfiguration in cdnConfigurations) {
            Console.WriteLine("A CDN configuration with ID \"{0}\" and name \"{1}\" was created.",
