    ...
    public class ApproveSuggestedAdUnits : SampleBase
    {
        ...
        public void Run(DfpUser user)
        {
            using (SuggestedAdUnitService suggestedAdUnitService =
                (SuggestedAdUnitService) user.GetService(DfpService.v201805.SuggestedAdUnitService))
            {
                ...
                try
                {
                    ...
                    // Create action.
                    Google.Api.Ads.Dfp.v201805.ApproveSuggestedAdUnits action =
                        new Google.Api.Ads.Dfp.v201805.ApproveSuggestedAdUnits();
