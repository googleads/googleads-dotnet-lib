...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201802
{
    ...
    public class GetAllContentMetadataKeyHierarchies : SampleBase
    {
        ...
        {
            get { return "This example gets all content metadata key hierarchies."; }
        }
        ...
        {
            GetAllContentMetadataKeyHierarchies codeExample =
                new GetAllContentMetadataKeyHierarchies();
            ...
            {
                Console.WriteLine(
                    "Failed to get content metadata key hierarchies. Exception says \"{0}\"",
                    e.Message);
            }
        }
        ...
        public void Run(DfpUser dfpUser)
        {
            using (ContentMetadataKeyHierarchyService contentMetadataKeyHierarchyService =
                (ContentMetadataKeyHierarchyService) dfpUser.GetService(DfpService.v201802
