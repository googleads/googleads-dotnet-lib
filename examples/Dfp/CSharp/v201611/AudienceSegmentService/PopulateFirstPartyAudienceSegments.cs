...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201611 {
  ...
  public class PopulateFirstPartyAudienceSegments : SampleBase {
    ...
    public static void Main() {
      PopulateFirstPartyAudienceSegments codeExample = new PopulateFirstPartyAudienceSegments();
    ...
    public void Run(DfpUser user) {
      ...
      AudienceSegmentService audienceSegmentService =
          (AudienceSegmentService) user.GetService(DfpService.v201611.AudienceSegmentService);
