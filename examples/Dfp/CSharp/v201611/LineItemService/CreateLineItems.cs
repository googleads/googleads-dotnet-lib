  ...
  public class CreateLineItems : SampleBase {
    ...
    public void Run(DfpUser user) {
      ...
      LineItemService lineItemService =
          (LineItemService) user.GetService(DfpService.v201611.LineItemService);
      ...
      saturdayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201611.DayOfWeek.SATURDAY;
      ...
      sundayDayPart.dayOfWeek = Google.Api.Ads.Dfp.v201611.DayOfWeek.SUNDAY;
