  ...
  public class TriggerWorkflowExternalConditionRequests : SampleBase {
    ...
    public void Run(DfpUser user) {
      ...
      WorkflowRequestService proposalLineItemService =
          (WorkflowRequestService) user.GetService(DfpService.v201611.WorkflowRequestService);
      ...
      try {
        ...
        if (workflowRequestIds.Count > 0) {
          ...
          // Create action.
          Google.Api.Ads.Dfp.v201611.TriggerWorkflowExternalConditionRequests action =
              new Google.Api.Ads.Dfp.v201611.TriggerWorkflowExternalConditionRequests();
