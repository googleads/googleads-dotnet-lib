...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201508 {
  ...
  /// </summary>
  public class GetBaseRatesByStatement : SampleBase {
    /// <summary>
    ...
    public static void Main() {
      GetBaseRatesByStatement codeExample = new GetBaseRatesByStatement();
    ...
    public void Run(DfpUser user) {
      ...
      BaseRateService baseRateService =
          (BaseRateService) user.GetService(DfpService.v201508.BaseRateService);
