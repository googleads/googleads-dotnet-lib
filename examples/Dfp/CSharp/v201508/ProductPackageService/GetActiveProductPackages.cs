...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201508 {
  /// <summary>
  /// This code example gets all active product packages. To create product packages, run
  /// CreateProductPackages.cs.
  /// </summary>
  class GetActiveProductPackages : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This code example gets all active product packages. To create " +
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new GetActiveProductPackages();
    ...
    public override void Run(DfpUser user) {
      ...
      ProductPackageService productPackageService =
          (ProductPackageService) user.GetService(DfpService.v201508.ProductPackageService);

      // Create a statement to only select active product packages.
