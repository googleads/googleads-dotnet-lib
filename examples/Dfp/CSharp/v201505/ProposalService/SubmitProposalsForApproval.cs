...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201505 {
  ...
  ///
  /// Tags: ProposalService.getProposalsByStatement, ProposalService.performProposalAction
  /// </summary>
    ...
    public override void Run(DfpUser user) {
      ...
      try {
        ...
        if (proposalIds.Count > 0) {
          ...
          // Create action.
          Dfp.v201505.SubmitProposalsForApproval action =
              new Dfp.v201505.SubmitProposalsForApproval();
