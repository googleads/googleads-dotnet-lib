...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201605 {
  ...
  /// </summary>
  public class GetAllLineItemCustomFields : SampleBase {
    /// <summary>
    ...
    public static void Main() {
      GetAllLineItemCustomFields codeExample = new GetAllLineItemCustomFields();
    ...
    public void Run(DfpUser user) {
      ...
      CustomFieldService customFieldService = (CustomFieldService) user.GetService(
          DfpService.v201605.CustomFieldService);
