    ...
    public override string Description {
      get {
        return "This code example gets geographic criteria from the Geo_Target table, such as " +
            ...
            "types can be found at https://developers.google.com/doubleclick-publishers/docs/reference/v201608/PublisherQueryLanguageService";
      }
    }
    ...
    public void Run(DfpUser user) {
      ...
      PublisherQueryLanguageService pqlService =
          (PublisherQueryLanguageService) user.GetService(
              DfpService.v201608.PublisherQueryLanguageService);
