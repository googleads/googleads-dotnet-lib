  ...
  public class ApproveSuggestedAdUnits : SampleBase {
    ...
    public void Run(DfpUser user) {
      ...
      SuggestedAdUnitService suggestedAdUnitService = (SuggestedAdUnitService) user.GetService(
          DfpService.v201608.SuggestedAdUnitService);
      ...
      try {
        ...
        // Create action.
        Google.Api.Ads.Dfp.v201608.ApproveSuggestedAdUnits action =
            new Google.Api.Ads.Dfp.v201608.ApproveSuggestedAdUnits();
