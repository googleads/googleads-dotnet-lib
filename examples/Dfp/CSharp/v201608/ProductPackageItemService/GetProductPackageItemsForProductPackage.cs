...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201608 {
  ...
  public class GetProductPackageItemsForProductPackage : SampleBase {
    ...
    public override string Description {
      get {
        return "This example gets all product package items belonging to a product package.";
      }
    }
    ...
    public static void Main() {
      ...
      try {
        codeExample.Run(new DfpUser(), productPackageId);
      } catch (Exception e) {
    ...
    public void Run(DfpUser dfpUser, long productPackageId) {
      ProductPackageItemService productPackageItemService =
          (ProductPackageItemService) dfpUser.GetService(DfpService.v201608.ProductPackageItemService);
