...
Namespace Google.Api.Ads.AdWords.Examples.VB.v13
  ...
  Class ReportServiceKeywordDemo
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New ReportServiceKeywordDemo
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      reportJob.selectedColumns = New String() {"Campaign", "AdGroup", "Keyword", "KeywordStatus", _
          "KeywordMinCPC", "KeywordDestUrlDisplay", "Impressions", "Clicks", "CTR", _
          "AveragePosition"}
