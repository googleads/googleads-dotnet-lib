...
Namespace Google.Api.Ads.AdWords.Examples.VB.v13
  ...
  Class DownloadReportAsXmlDemo
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New DownloadReportAsXmlDemo
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      reportJob.endDay = New Nullable(Of DateTime)(DateTime.Today)
      reportJob.startDay = New DateTime(&H7D9, 1, 1)
      ...
      Dim filePath As String = "C:\report.xml"

      ' Option 1: Call the async version and wait on delegate handle
      ' Suited for UI as well as console applications, depending on
      ' the context.
      Dim result As IAsyncResult = utilities.BeginDownloadReportAsXml(reportJob, filePath, Nothing)
      ...
      utilities.BeginDownloadReportAsXml(reportJob, filePath, New AsyncCallback( _
