...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201101
  ...
  ''' GetAllExperiments.vb. To add an experiment, run AddExperiment.vb.
  '''
  ...
  Class DeleteExperiment
    ...
    Public Overrides ReadOnly Property Description() As String
      Get
        Return "This code example deletes an experiment. To get experiments, run " & _
            "GetAllExperiments.vb.To add an experiment, run AddExperiment.vb."
      End Get
    End Property
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New DeleteExperiment
      ...
      Try
        ...
        If ((Not retVal Is Nothing) AndAlso (Not retVal.value Is Nothing)) Then
          For Each tempExperiment As Experiment In retVal.value
            Console.WriteLine("Experiment with name = ""{0}"" and id = ""{1}"" was deleted.", _
