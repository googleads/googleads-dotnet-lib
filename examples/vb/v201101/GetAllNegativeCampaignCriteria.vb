  ...
  Class GetAllNegativeCampaignCriteria
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
        ...
        If ((Not page Is Nothing) AndAlso (Not page.entries Is Nothing)) Then
          For Each campaignCriterion As CampaignCriterion In page.entries
            If TypeOf campaignCriterion.criterion Is Keyword Then
              ...
              Console.WriteLine("Negative keyword campaign criterion with campaign ID = " & _
      ...
      Catch ex As Exception
        Console.WriteLine("Failed to retrieve negative campaign criteria. Exception says " & _
            """{0}""", ex.Message)
      End Try
    End Sub
  End Class
