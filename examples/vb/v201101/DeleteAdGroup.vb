...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201101
  ...
  ''' To get ad groups, run GetAllAdGroups.vb.
  '''
  ...
  Class DeleteAdGroup
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New DeleteAdGroup
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Dim adGroupService As AdGroupService = user.GetService(AdWordsService.v201101.AdGroupService)
      ...
      Try
        ...
        If ((Not retVal Is Nothing) AndAlso (Not retVal.value Is Nothing) AndAlso _
          ...
          For Each temp As AdGroup In retVal.value
            Console.WriteLine("Ad group with name = ""{0}"" and id = ""{1}"" was deleted.", _
                temp.name, temp.id)
          Next
        Else
