...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201101
  ...
  Class GetOperationCount
    ...
    Public Overrides ReadOnly Property Description() As String
      Get
        Return "This code example retrieves the number of operations recorded for the " & _
            "developer token being used to make this call over the given date range."
      End Get
    End Property
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New GetOperationCount
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Dim infoService As InfoService = user.GetService( _
          AdWordsService.v201101.InfoService)
      ...
      Try
        ...
        If (Not info Is Nothing) Then
          Console.WriteLine("The total number of operations made during '{0}' - '{1}' is '{2}'.", _
