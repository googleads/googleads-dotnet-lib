...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201109
  ''' <summary>
  ''' This code example gets a bulk mutate job by id. To add a bulk mutate job,
  ''' run PerformBulkMutateJob.vb.
  '''
  ''' Tags: BulkMutateJobService.get
  ''' </summary>
  Class GetBulkMutateJob
    Inherits SampleBase
    ''' <summary>
    ...
    Public Overrides ReadOnly Property Description() As String
      Get
        Return "This code example gets a bulk mutate job by id. To add a bulk mutate job, " & _
            "run PerformBulkMutateJob.vb."
      End Get
    End Property
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New GetBulkMutateJob
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Dim bulkMutateJobService As BulkMutateJobService = user.GetService( _
          AdWordsService.v201109.BulkMutateJobService)

      Dim jobId As Long = Long.Parse(MyBase._T("INSERT_BULK_MUTATE_JOBID_HERE"))
