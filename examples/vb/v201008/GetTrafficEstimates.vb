...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201008
  ...
  Class GetTrafficEstimates
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New GetTrafficEstimates
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Dim countryTarget As New CountryTarget
      countryTarget.countryCode = "US"

      Dim languageTarget As New LanguageTarget
          ...
          If ((Not campaignEstimate.adGroupEstimates Is Nothing) AndAlso _
            ...
            If (Not adGroupEstimate.keywordEstimates Is Nothing) Then
              For i As Integer = 0 To adGroupEstimate.keywordEstimates.Length - 1
                ...
                Dim meanClicks As Long = ((keywordEstimate.min.clicks + _
                ...
                Console.WriteLine("  Estimated daily cost: {0}" & ChrW(10), meanTotalCost)
              Next i
            End If
          End If
        Else
      ...
      Catch ex As Exception
        Console.WriteLine("Failed to retrieve traffic estimates. Exception says ""{0}""", _
            ex.Message)
      End Try
    End Sub
  End Class
