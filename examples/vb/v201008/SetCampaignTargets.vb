...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201008
  ...
  Class SetCampaignTargets
    ...
    Public Overrides ReadOnly Property Description() As String
      Get
        Return "This code example adds geo, language, and network targeting to an existing " & _
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Dim networkTargetOperation As New CampaignTargetOperation
      ...
      Try
        ...
        Dim retVal As CampaignTargetReturnValue = campaignTargetService.mutate( _
            New CampaignTargetOperation() {geoTargetOperation, langTargetOperation, _
