...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201008
  ...
  Class ClientApiUnitsUsageDemo
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      ...
      Console.WriteLine(ChrW(10) & "Breakup of unit consumption by account (rolled up to MCCs)")
      Console.WriteLine("==========================================================")
      ...
      Console.WriteLine(ChrW(10) & "Total units consumed for this run : {0}", user.GetUnits)
    End Sub
  End Class
End Namespace
