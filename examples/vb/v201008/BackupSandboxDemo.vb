...
Namespace Google.Api.Ads.AdWords.Examples.VB.v201008
  ...
  Class BackupSandboxDemo
    ...
    Public Shared Sub Main(ByVal args As String())
      Dim codeExample As SampleBase = New BackupSandboxDemo
    ...
    Public Overrides Sub Run(ByVal user As AdWordsUser)
      DataUtilities.DownloadSandboxContents(user, String.Format("{0}\SandboxBackup-{1}.xml", _
