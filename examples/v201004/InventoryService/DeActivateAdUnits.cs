...
namespace Google.Api.Ads.Dfp.Examples.v201004 {
  ...
  class DeActivateAdUnits : SampleBase {
    ...
    public override void Run(DfpUser user) {
      ...
      Statement statement = new StatementBuilder("").AddParam("status",
      ...
      try {
        ...
        if (adUnitIds.Count > 0) {
          ...
          statement = new StatementBuilder("WHERE id IN (:ids)").AddParam("ids",
              String.Join(",", adUnitIds.ToArray())).ToStatement();
