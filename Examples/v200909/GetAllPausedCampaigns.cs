...
namespace com.google.api.adwords.samples.v200909 {
  /// <summary>
  /// This example gets all paused campaigns. To add a campaign, run AddCampaign.cs.
  /// </summary>
  class GetAllPausedCampaigns : SampleBase {
    ...
    public override string Description {
      get {
        return "This example gets all paused campaigns. To add a campaign, run AddCampaign.cs.";
      }
    }
