...
namespace com.google.api.adwords.samples.v200909 {
  /// <summary>
  /// This example retrieves the total number of API units for this entire
  ...
  class GetTotalUsageUnitsPerMonth : SampleBase {
    ...
    public override string Description {
      get {
        return "This example retrieves the total number of API units for this entire month that " +
