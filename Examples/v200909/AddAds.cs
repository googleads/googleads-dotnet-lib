...
namespace com.google.api.adwords.samples.v200909 {
  /// <summary>
  /// This code example shows how to add an image Ad and a text Ad to a given
  /// AdGroup. To create an AdGroup, run AddAdGroup.cs.
  /// </summary>
  class AddAds : SampleBase {
    ...
    public override string Description {
      get {
        return "This code example shows how to add an image Ad and a text Ad to a given AdGroup." +
            " To create an AdGroup, run AddAdGroup.cs.";
      }
    }
