...
namespace com.google.api.adwords.samples.v200909 {
  /// <summary>
  /// This example retrieves the number of API units recorded for the developer
  ...
  class GetUnitCount : SampleBase {
    ...
    public override string Description {
      get {
        return "This example retrieves the number of API units recorded for the developer" +
            " token being used to make this call over the given date range.";
      }
    }
