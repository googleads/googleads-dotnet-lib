...
namespace com.google.api.adwords.samples.v200909 {
  /// <summary>
  /// This demo shows how to add ads and keywords using BulkMutateJobService.
  /// </summary>
  class BulkMutateJobDemo : SampleBase {
    /// <summary>
    /// Returns a description about the sample code.
    /// </summary>
    public override string Description {
      get {
        return "This demo shows how to add ads and keywords using BulkMutateJobService.";
      }
    }
    ...
    public override void Run(AdWordsUser user) {
      long campaignId = long.Parse(_T("INSERT_CUSTOMER_ID_HERE"));
      ...
      adOpStream.scopingEntityId.type = EntityIdType.CUSTOMER_ID;
      ...
      keywordOpStream.scopingEntityId.type = EntityIdType.CUSTOMER_ID;
