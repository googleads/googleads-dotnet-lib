  ...
  class GetAllAccountChanges : SampleBase {
    ...
    public override void Run(AdWordsUser user) {
      ...
      CustomerSyncService customerSyncService =
          (CustomerSyncService) user.GetService(AdWordsService.v201008.
              CustomerSyncService);

      // The date time string should be of the form  yyyyMMdd HHmmss zzz
      string minDateTime = _T("INSERT_START_DATE_TIME_HERE");
      string maxDateTime = _T("INSERT_END_DATE_TIME_HERE");
