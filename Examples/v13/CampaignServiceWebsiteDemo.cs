...
namespace com.google.api.adwords.samples.v13 {
  ...
  /// </summary>
  class CampaignServiceWebsiteDemo : SampleBase {
    /// <summary>
    /// Returns a description about the sample code.
    /// </summary>
    public override string Description {
      get {
        return "Creates new campaign, ad group, text ad, and a website criterion.";
      }
    }
    ...
    public override void Run(AdWordsUser user) {
      ...
      Criterion[] myWebsites = criterionService.addCriteria(new Criterion[] {newWebsite});
      ...
      for (int i = 0; i < myWebsites.Length; i++) {
        ...
        Console.WriteLine("{0}: maxCpm = {1}", myWebsite.url, myWebsite.maxCpm);
      }
    }
  }
}
