...
namespace com.google.api.adwords.samples.v13 {
  ...
  /// </summary>
  class CampaignServiceDemo : SampleBase {
    /// <summary>
    /// Returns a description about the sample code.
    /// </summary>
    public override string Description {
      get {
        return "Creates new campaign, ad group, text ad, and some keywords.";
      }
    }
    ...
    public override void Run(AdWordsUser user) {
      ...
      Console.WriteLine("New text ad added to AdGroup {0} - {1}", adGroupId, myAds[0].id);
      ...
      for (int i = 0; i < myKeywords.Length; i++) {
        ...
        Console.WriteLine("{0}: id = {1}, maxCpc = {2}", myKeyword.text, myKeyword.id,
            myKeyword.maxCpc);
      }
