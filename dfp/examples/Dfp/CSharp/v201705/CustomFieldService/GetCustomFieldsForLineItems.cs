...
namespace Google.Api.Ads.Dfp.Examples.CSharp.v201705 {
  ...
  public class GetCustomFieldsForLineItems : SampleBase {
    ...
    public override string Description {
      get {
        return "This example gets all custom fields that can be applied to line items.";
      }
    }
    ...
    public void Run(DfpUser dfpUser) {
      CustomFieldService customFieldService =
          (CustomFieldService) dfpUser.GetService(DfpService.v201705.CustomFieldService);
