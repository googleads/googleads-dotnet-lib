...
namespace Google.Api.Ads.Dfp.Examples.CSharp {
  ...
  public abstract class SampleBase {
    ...
    /// </param>
    /// <remarks>
    /// When called in interactive mode, presents the provided string as a prompt to the user and
    /// returns the user provided input. Otherwise, returns the provided string exactly.
    /// </remarks>
