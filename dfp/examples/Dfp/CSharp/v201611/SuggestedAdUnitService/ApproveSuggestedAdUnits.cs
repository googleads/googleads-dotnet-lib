  ...
  public class ApproveSuggestedAdUnits : SampleBase {
    ...
    public void Run(DfpUser user) {
      ...
      SuggestedAdUnitService suggestedAdUnitService = (SuggestedAdUnitService) user.GetService(
          DfpService.v201611.SuggestedAdUnitService);
      ...
      try {
        ...
        // Create action.
        Google.Api.Ads.Dfp.v201611.ApproveSuggestedAdUnits action =
            new Google.Api.Ads.Dfp.v201611.ApproveSuggestedAdUnits();
